...
add the following contents to a new file `MyApp.cs`. This code will:
...
```c#
// MyApp.cs
{% include_relative MyApp.cs %}
```

To run your app, compile it with the C# compiler of your choice (eg. Visual Studio, VS Code, csc.exe, etc.) and run it.
