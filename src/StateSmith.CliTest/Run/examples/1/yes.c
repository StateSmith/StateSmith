...
static void exit_up_to_state_handler(yes* sm, yes_Func desired_state_exit_handler);

static void ROOT_enter(yes* sm);

static void ROOT_exit(yes* sm);

static void STATE_1_enter(yes* sm);

static void STATE_1_exit(yes* sm);

static void STATE_1_do(yes* sm);

static void STATE_1_my_event_1(yes* sm);

static void STATE_2_enter(yes* sm);

static void STATE_2_exit(yes* sm);

static void STATE_2_my_event_2(yes* sm);
...
void yes_start(yes* sm)
{
    ...
    // uml: TransitionTo(ROOT.<InitialState>)
    {
        ...
        // uml: TransitionTo(STATE_1)
        {
            ...
            sm->state_id = yes_StateId_STATE_1;
...
{
    yes_Func behavior_func = sm->current_event_handlers[event_id];
...
static void STATE_1_enter(yes* sm)
{
    ...
    sm->current_event_handlers[yes_EventId_DO] = STATE_1_do;
    sm->current_event_handlers[yes_EventId_MY_EVENT_1] = STATE_1_my_event_1;
...
static void STATE_1_exit(yes* sm)
{
    ...
    sm->current_state_exit_handler = ROOT_exit;
    sm->current_event_handlers[yes_EventId_DO] = NULL;  // no ancestor listens to this event
    sm->current_event_handlers[yes_EventId_MY_EVENT_1] = NULL;  // no ancestor listens to this event
}
...
static void STATE_1_my_event_1(yes* sm)
{
    ...
    // uml: MY_EVENT_1 TransitionTo(STATE_2)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = yes_StateId_STATE_2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for STATE_1
}
...
static void STATE_2_enter(yes* sm)
{
    ...
    sm->current_event_handlers[yes_EventId_MY_EVENT_2] = STATE_2_my_event_2;
...
static void STATE_2_exit(yes* sm)
{
    ...
    // adjust function pointers for this state's exit
    sm->current_state_exit_handler = ROOT_exit;
    sm->current_event_handlers[yes_EventId_MY_EVENT_2] = NULL;  // no ancestor listens to this event
}
...
char const * yes_state_id_to_string(yes_StateId id)
{
    switch (id)
    {
        case yes_StateId_ROOT: return "ROOT";
        case yes_StateId_STATE_1: return "STATE_1";
        case yes_StateId_STATE_2: return "STATE_2";
        default: return "?";
    }
}
...
char const * yes_event_id_to_string(yes_EventId id)
{
    switch (id)
    {
        case yes_EventId_DO: return "DO";
        case yes_EventId_MY_EVENT_1: return "MY_EVENT_1";
        case yes_EventId_MY_EVENT_2: return "MY_EVENT_2";
        default: return "?";
    }
}
