...
static void exit_up_to_state_handler(a1c* sm, a1c_Func desired_state_exit_handler);

static void ROOT_enter(a1c* sm);

static void ROOT_exit(a1c* sm);

static void STATE_1_enter(a1c* sm);

static void STATE_1_exit(a1c* sm);

static void STATE_1_do(a1c* sm);

static void STATE_1_my_event_1(a1c* sm);

static void STATE_2_enter(a1c* sm);

static void STATE_2_exit(a1c* sm);

static void STATE_2_my_event_2(a1c* sm);
...
void a1c_start(a1c* sm)
{
    ...
    // uml: TransitionTo(ROOT.<InitialState>)
    {
        ...
        // uml: TransitionTo(STATE_1)
        {
            ...
            sm->state_id = a1c_StateId_STATE_1;
...
{
    a1c_Func behavior_func = sm->current_event_handlers[event_id];
...
static void STATE_1_enter(a1c* sm)
{
    ...
    sm->current_event_handlers[a1c_EventId_DO] = STATE_1_do;
    sm->current_event_handlers[a1c_EventId_MY_EVENT_1] = STATE_1_my_event_1;
...
static void STATE_1_exit(a1c* sm)
{
    ...
    sm->current_state_exit_handler = ROOT_exit;
    sm->current_event_handlers[a1c_EventId_DO] = NULL;  // no ancestor listens to this event
    sm->current_event_handlers[a1c_EventId_MY_EVENT_1] = NULL;  // no ancestor listens to this event
}
...
static void STATE_1_my_event_1(a1c* sm)
{
    ...
    // uml: MY_EVENT_1 TransitionTo(STATE_2)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = a1c_StateId_STATE_2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for STATE_1
}
...
static void STATE_2_enter(a1c* sm)
{
    ...
    sm->current_event_handlers[a1c_EventId_MY_EVENT_2] = STATE_2_my_event_2;
...
static void STATE_2_exit(a1c* sm)
{
    ...
    // adjust function pointers for this state's exit
    sm->current_state_exit_handler = ROOT_exit;
    sm->current_event_handlers[a1c_EventId_MY_EVENT_2] = NULL;  // no ancestor listens to this event
}
...
char const * a1c_state_id_to_string(a1c_StateId id)
{
    switch (id)
    {
        case a1c_StateId_ROOT: return "ROOT";
        case a1c_StateId_STATE_1: return "STATE_1";
        case a1c_StateId_STATE_2: return "STATE_2";
        default: return "?";
    }
}
...
char const * a1c_event_id_to_string(a1c_EventId id)
{
    switch (id)
    {
        case a1c_EventId_DO: return "DO";
        case a1c_EventId_MY_EVENT_1: return "MY_EVENT_1";
        case a1c_EventId_MY_EVENT_2: return "MY_EVENT_2";
        default: return "?";
    }
}
