...
static void BOOM_enter(Tutorial1Sm* sm);

static void BOOM_exit(Tutorial1Sm* sm);
...
static void ON_GROUP_enter(Tutorial1Sm* sm);

static void ON_GROUP_exit(Tutorial1Sm* sm);

static void ON_GROUP_off(Tutorial1Sm* sm);
...
static void ON1_increase(Tutorial1Sm* sm);

static void ON2_enter(Tutorial1Sm* sm);

static void ON2_exit(Tutorial1Sm* sm);

static void ON2_dim(Tutorial1Sm* sm);

static void ON2_increase(Tutorial1Sm* sm);

static void ON3_enter(Tutorial1Sm* sm);

static void ON3_exit(Tutorial1Sm* sm);

static void ON3_dim(Tutorial1Sm* sm);

static void ON3_increase(Tutorial1Sm* sm);
...
{
    // setup trigger/event handlers
    sm->current_state_exit_handler = BOOM_exit;
...
static void ON_GROUP_enter(Tutorial1Sm* sm)
{
    ...
    sm->current_event_handlers[Tutorial1Sm_EventId_OFF] = ON_GROUP_off;
}
...
static void ON_GROUP_exit(Tutorial1Sm* sm)
{
    // adjust function pointers for this state's exit
    sm->current_state_exit_handler = ROOT_exit;
    sm->current_event_handlers[Tutorial1Sm_EventId_OFF] = NULL;  // no ancestor listens to this event
}
...
static void ON1_enter(Tutorial1Sm* sm)
{
    ...
    sm->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = ON1_increase;
...
static void ON1_increase(Tutorial1Sm* sm)
{
    ...
    // uml: INCREASE TransitionTo(ON2)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = Tutorial1Sm_StateId_ON2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for ON1
}
...
static void ON2_enter(Tutorial1Sm* sm)
{
    ...
    sm->current_event_handlers[Tutorial1Sm_EventId_DIM] = ON2_dim;
    sm->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = ON2_increase;
...
static void ON2_increase(Tutorial1Sm* sm)
{
    ...
    // uml: INCREASE TransitionTo(ON3)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = Tutorial1Sm_StateId_ON3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for ON2
}
...
static void ON3_enter(Tutorial1Sm* sm)
{
    ...
    sm->current_event_handlers[Tutorial1Sm_EventId_DIM] = ON3_dim;
    sm->current_event_handlers[Tutorial1Sm_EventId_INCREASE] = ON3_increase;
...
static void ON3_increase(Tutorial1Sm* sm)
{
    ...
    if (sm->vars.count >= 3)
    {
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        sm->state_id = Tutorial1Sm_StateId_BOOM;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for ON3
}
...
char const * Tutorial1Sm_event_id_to_string(Tutorial1Sm_EventId id)
{
    switch (id)
    {
        ...
        case Tutorial1Sm_EventId_OFF: return "OFF";
        default: return "?";
    }
}
