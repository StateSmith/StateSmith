...
;
    ...
    {
        // setup trigger/event handlers
        this._currentStateExitHandler = this._AUTO_VAR_TEST_exit;
    ...
    _AUTO_VAR_TEST__BLAH_enter()
    {
        // setup trigger/event handlers
        this._currentStateExitHandler = this._AUTO_VAR_TEST__BLAH_exit;
        this._currentEventHandlers[Spec2Sm.EventId.DO] = this._AUTO_VAR_TEST__BLAH_do;
    ...
    _AUTO_VAR_TEST__BLAH_do()
    {
        ...
        if (trace_guard("State AUTO_VAR_TEST__BLAH: check behavior `[auto_var_1 > 0] TransitionTo(AUTO_VAR_TEST__BLAH2)`.", auto_var_1 > 0))
        {
            // Step 1: Exit states until we reach `AUTO_VAR_TEST` state (Least Common Ancestor for transition).
            this._AUTO_VAR_TEST__BLAH_exit();
            
            // Step 2: Transition action: `trace("Transition action `` for AUTO_VAR_TEST__BLAH to AUTO_VAR_TEST__BLAH2.");`.
            console.log("Transition action `` for AUTO_VAR_TEST__BLAH to AUTO_VAR_TEST__BLAH2.");
            
            // Step 3: Enter/move towards transition target `AUTO_VAR_TEST__BLAH2`.
            this._AUTO_VAR_TEST__BLAH2_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.stateId = Spec2Sm.StateId.AUTO_VAR_TEST__BLAH2;
            // No ancestor handles event. Can skip nulling `ancestorEventHandler`.
            return;
        } // end of behavior for AUTO_VAR_TEST__BLAH
    }
    ...
    _AUTO_VAR_TEST__BLAH2_enter()
    {
        // setup trigger/event handlers
        this._currentStateExitHandler = this._AUTO_VAR_TEST__BLAH2_exit;
        ...
        if (trace_guard("State DECIDE: check behavior `EV6 TransitionTo(TEST6_VARIABLES)`.", true))
        {
            ...
            // uml: / { trace("Transition action `` for TEST6_VARIABLES.InitialState to TEST6_ROOT."); } TransitionTo(TEST6_ROOT)
            {
                ...
                // uml: / { trace("Transition action `` for TEST6_ROOT.InitialState to TEST6_S1."); } TransitionTo(TEST6_S1)
                {
                    ...
                    console.log("Transition action `` for TEST6_ROOT.InitialState to TEST6_S1.");
                    
                    // Step 3: Enter/move towards transition target `TEST6_S1`.
                    this._TEST6_S1_enter();
                    
                    // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                    this.stateId = Spec2Sm.StateId.TEST6_S1;
                    // No ancestor handles event. Can skip nulling `ancestorEventHandler`.
                    return;
    ...
    {
        // setup trigger/event handlers
        this._currentStateExitHandler = this._TEST6_S1_exit;
        this._currentEventHandlers[Spec2Sm.EventId.EV1] = this._TEST6_S1_ev1;
        
        // TEST6_S1 behavior
        // uml: enter / { trace("Enter TEST6_S1."); }
        {
            // Step 1: execute action `trace("Enter TEST6_S1.");`
            console.log("Enter TEST6_S1.");
    ...
    _TEST6_S1_ev1()
    {
        ...
        if (trace_guard("State TEST6_S1: check behavior `2. EV1 [count >= 2] TransitionTo(TEST6_S2)`.", this.vars.count >= 2))
        {
            ...
            console.log("Transition action `` for TEST6_S1 to TEST6_S2.");
            
            // Step 3: Enter/move towards transition target `TEST6_S2`.
            this._TEST6_S2_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.stateId = Spec2Sm.StateId.TEST6_S2;
            // No ancestor handles event. Can skip nulling `ancestorEventHandler`.
            return;
        } // end of behavior for TEST6_S1
    }
    ...
    {
        // setup trigger/event handlers
        this._currentStateExitHandler = this._TEST6_S2_exit;
        
        // TEST6_S2 behavior
        // uml: enter / { trace("Enter TEST6_S2."); }
        {
            // Step 1: execute action `trace("Enter TEST6_S2.");`
            console.log("Enter TEST6_S2.");
    ...
    StateIdToString(/** @type {Spec2Sm.StateId} */ id)
    {
        switch (id)
        {
            ...
            case Spec2Sm.StateId.AUTO_VAR_TEST__BLAH: return "AUTO_VAR_TEST__BLAH";
            case Spec2Sm.StateId.AUTO_VAR_TEST__BLAH2: return "AUTO_VAR_TEST__BLAH2";
            ...
            case Spec2Sm.StateId.TEST6_S1: return "TEST6_S1";
            case Spec2Sm.StateId.TEST6_S2: return "TEST6_S2";
