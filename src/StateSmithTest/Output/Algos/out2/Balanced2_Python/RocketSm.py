...
class RocketSm():
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.ROOT_SubtreeEndId = 4  # State 'RocketSm' subtree extends from itself (id: 0) to state 's1' (id: 4)
        ...
        self.S1_SubtreeEndId = 4  # State 's1' subtree extends from itself (id: 4) to state 's1' (id: 4)
