...
public class GilToC99Tests
{
    ...
    public void Test()
    {
        ...
        GilToC99 gilToC = new(outputInfo, new GilToC99Customizer(renderConfigC, outputInfo), new CodeFileWriter(new StringBuilderConsolePrinter(), pathPrinter), renderConfig, renderConfigC, new(), new());
