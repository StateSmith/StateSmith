...
typedef enum PlantEx2_EventId
{
    ...
    PlantEx2_EventId_EVCONFIG = 2,
    PlantEx2_EventId_EVNEWVALUE = 3,
    PlantEx2_EventId_EVNEWVALUEREJECTED = 4,
    PlantEx2_EventId_EVNEWVALUESAVED = 5
} PlantEx2_EventId;

enum
{
    PlantEx2_EventIdCount = 6
};
