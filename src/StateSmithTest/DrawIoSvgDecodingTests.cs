...
public class DrawIoSvgDecodingTests
{
    ...
    public void Decompress()
    {
        ...
        var actual = DrawIoSvgDecoder.DecompressContent(input);
    ...
    {
        var contents = DrawIoSvgDecoder.GetDiagramCompressedContents("""<mxfile><diagram id="Tqm6eFcu1KHT34LG2WWE" name="Page-1">blah123</diagram></mxfile>""");
    ...
    {
        var contents = DrawIoSvgDecoder.GetDiagramCompressedContents("""
            <mxfile>
    ...
    {
        Action action = () => DrawIoSvgDecoder.GetDiagramCompressedContents("""<Mxfile><diagram id="Tqm6eFcu1KHT34LG2WWE" name="Page-1">blah123</diagram></mxfile>""");
    ...
    {
        Action action = () => DrawIoSvgDecoder.GetDiagramCompressedContents("""<mxfile><SomeDiagram id="Tqm6eFcu1KHT34LG2WWE" name="Page-1">blah123</diagram></mxfile>""");
    ...
    {
        Action action = () => DrawIoSvgDecoder.GetDiagramCompressedContents("""
            <mxfile>
    ...
    [Fact]
    public void DecodeFileToOriginalDiagram_MissingFile()
    {
        string filePath = AppDomain.CurrentDomain.BaseDirectory + "./Tutorial1Sm.drawio.svg_none";
        Action a = () => DrawIoSvgDecoder.DecodeFileToOriginalDiagram(filePath);
        a.Should().Throw<DrawIoException>().WithMessage("*Tutorial1Sm.drawio.svg_none*");
    }
    ...
    public void DecodeToOriginalDiagram_StaticString()
    {
        ...
        var actual = DrawIoSvgDecoder.DecodeToOriginalDiagram(new StringReader(svgFileStart));
        Assert.Equal(expected, actual);
    }
}
