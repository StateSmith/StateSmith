...
typedef enum Spec2Sm_StateId
{
    ...
    Spec2Sm_StateId_TEST6_ROOT__AUTO_VAR_TEST = 75,
    Spec2Sm_StateId_TEST6_ROOT__AUTO_VAR_TEST__S1 = 76,
    Spec2Sm_StateId_TEST6_ROOT__AUTO_VAR_TEST__S2 = 77,
    Spec2Sm_StateId_TEST6_ROOT__DECIDE = 78,
    Spec2Sm_StateId_TEST6_ROOT__NORMAL = 79,
    Spec2Sm_StateId_TEST6_ROOT__NORMAL__S1 = 80,
    Spec2Sm_StateId_TEST6_ROOT__NORMAL__S2 = 81,
    Spec2Sm_StateId_TEST7_INITIAL_OR_HISTORY = 82,
    Spec2Sm_StateId_TEST7 = 83,
    Spec2Sm_StateId_T7__DEEP_HISTORY1 = 84,
    Spec2Sm_StateId_T7__DH1__SANTAS_WORKSHOP = 85,
    Spec2Sm_StateId_T7__DH1__ALIENS_DETECTED = 86,
    Spec2Sm_StateId_T7__DH1__GET_BACKUP = 87,
    Spec2Sm_StateId_T7__DH1__HERO = 88,
    Spec2Sm_StateId_T7__DH1__CALL_BATMAN = 89,
    Spec2Sm_StateId_T7__DH1__CALL_THOR = 90,
    Spec2Sm_StateId_T7__DH1__LOCAL_HELP = 91,
    Spec2Sm_StateId_T7__DH1__BUDDY_ELF = 92,
    Spec2Sm_StateId_T7__DH1__POLAR_BEARS = 93,
    Spec2Sm_StateId_T7__DH1__GIVE_COOKIES = 94,
    Spec2Sm_StateId_T7__DH1__SNOWBALL_FIGHT = 95,
    Spec2Sm_StateId_T7__DH1__BUILD = 96,
    Spec2Sm_StateId_T7__DH1__TOOL = 97,
    Spec2Sm_StateId_T7__DH1__CIRCULAR_SAW = 98,
    Spec2Sm_StateId_T7__DH1__IMPACT_DRILL = 99,
    Spec2Sm_StateId_T7__DH1__TOY = 100,
    Spec2Sm_StateId_T7__DH1__GLOW_WORM = 101,
    Spec2Sm_StateId_T7__DH1__RACE_CAR = 102,
    Spec2Sm_StateId_T7__DH1__ROBOT = 103,
    Spec2Sm_StateId_T7__DH1__BATTLEBOT = 104,
    Spec2Sm_StateId_T7__DH1__WALL_E = 105,
    Spec2Sm_StateId_T7__DH1__TEDDY_BEAR = 106,
    Spec2Sm_StateId_T7__DEEP_HISTORY2 = 107,
    Spec2Sm_StateId_T7__DH2__STATE_0 = 108,
    Spec2Sm_StateId_T7__DH2__STATE_1 = 109,
    Spec2Sm_StateId_T7__DH2__STATE_2 = 110,
    Spec2Sm_StateId_T7__DH2__STATE_6 = 111,
    Spec2Sm_StateId_T7__DH2__STATE_9 = 112,
    Spec2Sm_StateId_T7__DH2__STATE_3 = 113,
    Spec2Sm_StateId_T7__DEEP_HISTORY3 = 114,
    Spec2Sm_StateId_T7__DH3__STATE_0 = 115,
    Spec2Sm_StateId_T7__DH3__STATE_1 = 116,
    Spec2Sm_StateId_T7__DH3__STATE_2 = 117,
    Spec2Sm_StateId_T7__DH3__STATE_6 = 118,
    Spec2Sm_StateId_T7__DH3__STATE_9 = 119,
    Spec2Sm_StateId_T7__DH3__STATE_3 = 120,
    Spec2Sm_StateId_T7__HISTORY1 = 121,
    Spec2Sm_StateId_T7__H1__OFF = 122,
    Spec2Sm_StateId_T7__H1__OFF1 = 123,
    Spec2Sm_StateId_T7__H1__OFF2 = 124,
    Spec2Sm_StateId_T7__H1__OFF3 = 125,
    Spec2Sm_StateId_T7__H1__ON = 126,
    Spec2Sm_StateId_T7__H1__ON1 = 127,
    Spec2Sm_StateId_T7__H1__ON2 = 128,
    Spec2Sm_StateId_T7__H1__ON3 = 129,
    Spec2Sm_StateId_T7__INITIAL1 = 130,
    Spec2Sm_StateId_T7__INITIAL1__PARENT = 131,
    Spec2Sm_StateId_T7__INITIAL1__G = 132,
    Spec2Sm_StateId_T7__INITIAL1__G_S1 = 133,
    Spec2Sm_StateId_T7__INITIAL1__G_S2 = 134,
    Spec2Sm_StateId_T7__INITIAL1__G_S3 = 135,
    Spec2Sm_StateId_T7__INITIAL1__S1 = 136,
    Spec2Sm_StateId_TEST7_DECIDE = 137,
    Spec2Sm_StateId_TEST8_ENTRY_CHOICE = 138,
    Spec2Sm_StateId_TEST8_ROOT = 139,
    Spec2Sm_StateId_TEST8_G = 140,
    Spec2Sm_StateId_TEST8_G_S1 = 141,
    Spec2Sm_StateId_TEST8_G_S2 = 142,
    Spec2Sm_StateId_TEST8_G_S3 = 143,
    Spec2Sm_StateId_TEST8_S1 = 144,
    Spec2Sm_StateId_TEST9_EXIT_CHOICE = 145,
    Spec2Sm_StateId_TEST9_DECIDE = 146,
    Spec2Sm_StateId_TEST9_ROOT = 147,
    Spec2Sm_StateId_TEST9_G_S1 = 148,
    Spec2Sm_StateId_TEST9_G_S2 = 149,
    Spec2Sm_StateId_TEST9_G_S3 = 150,
    Spec2Sm_StateId_TEST9_G_S4 = 151,
    Spec2Sm_StateId_TEST9_S1 = 152,
    Spec2Sm_StateId_TEST9_S1_1 = 153,
    Spec2Sm_StateId_TEST9A_ROOT = 154,
    Spec2Sm_StateId_TEST9A_S1 = 155,
    Spec2Sm_StateId_TEST9A_S1_1 = 156,
    Spec2Sm_StateId_TEST9B_ROOT = 157,
    Spec2Sm_StateId_TEST9B_ROOT__A1 = 158,
    Spec2Sm_StateId_TEST9B_ROOT__A2 = 159,
    Spec2Sm_StateId_TEST9B_ROOT__A3 = 160,
    Spec2Sm_StateId_TEST9B_ROOT__A4 = 161,
    Spec2Sm_StateId_TEST9B_ROOT__B1 = 162,
    Spec2Sm_StateId_TEST9B_ROOT__B2 = 163,
    Spec2Sm_StateId_TEST9B_ROOT__B3 = 164,
    Spec2Sm_StateId_TEST9B_ROOT__B4 = 165,
} Spec2Sm_StateId;

enum
{
    Spec2Sm_StateIdCount = 166
};
