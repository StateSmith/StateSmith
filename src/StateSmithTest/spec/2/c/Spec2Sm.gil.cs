...
public struct Vars
{
    ...
    //>>>>>ECHO:uint8_t count;
    //>>>>>ECHO:// some user AutoExpandedVars comments
    //>>>>>ECHO:uint8_t auto_var_1;
}
...
public void start()
{
    ...
    // uml: TransitionTo(ROOT.InitialState)
    {
        ...
        // uml: / { trace("Transition action `` for ROOT.InitialState to DECIDE."); } TransitionTo(DECIDE)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for ROOT.InitialState to DECIDE.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = AUTO_VAR_TEST__BLAH_exit;
    this.current_event_handlers[(int)EventId.DO] = AUTO_VAR_TEST__BLAH_do;
    ...
    // uml: enter / { trace("Enter AUTO_VAR_TEST__BLAH."); }
    {
        ...
        //>>>>>ECHO:trace("Enter AUTO_VAR_TEST__BLAH.");
...
private void AUTO_VAR_TEST__BLAH_exit()
{
    ...
    // uml: exit / { trace("Exit AUTO_VAR_TEST__BLAH."); }
    {
        ...
        //>>>>>ECHO:trace("Exit AUTO_VAR_TEST__BLAH.");
    } // end of behavior for AUTO_VAR_TEST__BLAH
...
private void AUTO_VAR_TEST__BLAH_do()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State AUTO_VAR_TEST__BLAH: check behavior `[auto_var_1 > 0] TransitionTo(AUTO_VAR_TEST__BLAH2)`.", self->vars.auto_var_1 > 0)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for AUTO_VAR_TEST__BLAH to AUTO_VAR_TEST__BLAH2.");
        
        // Step 3: Enter/move towards transition target `AUTO_VAR_TEST__BLAH2`.
        AUTO_VAR_TEST__BLAH2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.AUTO_VAR_TEST__BLAH2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for AUTO_VAR_TEST__BLAH
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = AUTO_VAR_TEST__BLAH2_exit;
    ...
    // uml: enter / { trace("Enter AUTO_VAR_TEST__BLAH2."); }
    {
        ...
        //>>>>>ECHO:trace("Enter AUTO_VAR_TEST__BLAH2.");
...
private void AUTO_VAR_TEST__BLAH2_exit()
{
    ...
    // uml: exit / { trace("Exit AUTO_VAR_TEST__BLAH2."); }
    {
        ...
        //>>>>>ECHO:trace("Exit AUTO_VAR_TEST__BLAH2.");
    } // end of behavior for AUTO_VAR_TEST__BLAH2
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = DECIDE_exit;
    this.current_event_handlers[(int)EventId.EV1] = DECIDE_ev1;
    this.current_event_handlers[(int)EventId.EV10] = DECIDE_ev10;
    this.current_event_handlers[(int)EventId.EV2] = DECIDE_ev2;
    this.current_event_handlers[(int)EventId.EV3] = DECIDE_ev3;
    this.current_event_handlers[(int)EventId.EV4] = DECIDE_ev4;
    this.current_event_handlers[(int)EventId.EV5] = DECIDE_ev5;
    this.current_event_handlers[(int)EventId.EV6] = DECIDE_ev6;
    this.current_event_handlers[(int)EventId.EV7] = DECIDE_ev7;
    this.current_event_handlers[(int)EventId.EV8] = DECIDE_ev8;
    this.current_event_handlers[(int)EventId.EV9] = DECIDE_ev9;
    
    // DECIDE behavior
    // uml: enter / { trace("Enter DECIDE."); }
    {
        // Step 1: execute action `trace("Enter DECIDE.");`
        //>>>>>ECHO:trace("Enter DECIDE.");
...
private void DECIDE_exit()
{
    ...
    // uml: exit / { trace("Exit DECIDE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit DECIDE.");
    } // end of behavior for DECIDE
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = ROOT_exit;
    this.current_event_handlers[(int)EventId.EV1] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV10] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV2] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV3] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV4] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV5] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV6] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV7] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV8] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV9] = null;  // no ancestor listens to this event
}
...
private void DECIDE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV1 TransitionTo(TEST1_DO_EVENT_TESTING)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST1_DO_EVENT_TESTING.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST1_DO_EVENT_TESTING.");
        ...
        // uml: / { trace("Transition action `` for TEST1_DO_EVENT_TESTING.InitialState to TEST1_ROOT."); } TransitionTo(TEST1_ROOT)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST1_DO_EVENT_TESTING.InitialState to TEST1_ROOT.");
            ...
            // uml: / { trace("Transition action `` for TEST1_ROOT.InitialState to TEST1_S1_1."); } TransitionTo(TEST1_S1_1)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST1_ROOT.InitialState to TEST1_S1_1.");
                ...
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST1_S1_1;
                // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
                return;
...
private void DECIDE_ev10()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV10 TransitionTo(TEST10_CHOICE_POINT)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST10_CHOICE_POINT.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST10_CHOICE_POINT.");
        ...
        // uml: / { trace("Transition action `` for TEST10_CHOICE_POINT.InitialState to TEST10_S1."); } TransitionTo(TEST10_S1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST10_CHOICE_POINT.InitialState to TEST10_S1.");
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST10_S1;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
private void DECIDE_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV2 TransitionTo(TEST2_REGULAR_EVENT_TESTING)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST2_REGULAR_EVENT_TESTING.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST2_REGULAR_EVENT_TESTING.");
        ...
        // uml: / { trace("Transition action `` for TEST2_REGULAR_EVENT_TESTING.InitialState to TEST2_ROOT."); } TransitionTo(TEST2_ROOT)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST2_REGULAR_EVENT_TESTING.InitialState to TEST2_ROOT.");
            ...
            // uml: / { trace("Transition action `` for TEST2_ROOT.InitialState to TEST2_S1_1."); } TransitionTo(TEST2_S1_1)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST2_ROOT.InitialState to TEST2_S1_1.");
                ...
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST2_S1_1;
                // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
                return;
...
private void DECIDE_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV3 TransitionTo(TEST3_BEHAVIOR_ORDERING)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST3_BEHAVIOR_ORDERING.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST3_BEHAVIOR_ORDERING.");
        ...
        // uml: / { trace("Transition action `` for TEST3_BEHAVIOR_ORDERING.InitialState to TEST3_ROOT."); } TransitionTo(TEST3_ROOT)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST3_BEHAVIOR_ORDERING.InitialState to TEST3_ROOT.");
            ...
            // uml: / { trace("Transition action `` for TEST3_ROOT.InitialState to TEST3_S1."); } TransitionTo(TEST3_S1)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST3_ROOT.InitialState to TEST3_S1.");
                
                // Step 3: Enter/move towards transition target `TEST3_S1`.
                TEST3_S1_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST3_S1;
                // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
                return;
...
private void DECIDE_ev4()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV4 TransitionTo(TEST4_PARENT_CHILD_TRANSITIONS)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST4_PARENT_CHILD_TRANSITIONS.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST4_PARENT_CHILD_TRANSITIONS.");
        ...
        // uml: / { trace("Transition action `` for TEST4_PARENT_CHILD_TRANSITIONS.InitialState to TEST4_DECIDE."); } TransitionTo(TEST4_DECIDE)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST4_PARENT_CHILD_TRANSITIONS.InitialState to TEST4_DECIDE.");
            
            // Step 3: Enter/move towards transition target `TEST4_DECIDE`.
            TEST4_DECIDE_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST4_DECIDE;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
private void DECIDE_ev5()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV5 TransitionTo(TEST5_PARENT_CHILD_TRANSITIONS_ALIAS)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST5_PARENT_CHILD_TRANSITIONS_ALIAS.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST5_PARENT_CHILD_TRANSITIONS_ALIAS.");
        ...
        // uml: / { trace("Transition action `` for TEST5_PARENT_CHILD_TRANSITIONS_ALIAS.InitialState to TEST5_ROOT."); } TransitionTo(TEST5_ROOT)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST5_PARENT_CHILD_TRANSITIONS_ALIAS.InitialState to TEST5_ROOT.");
            
            // Step 3: Enter/move towards transition target `TEST5_ROOT`.
            TEST5_ROOT_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST5_ROOT;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
private void DECIDE_ev6()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV6 TransitionTo(TEST6_VARIABLES)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST6_VARIABLES.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST6_VARIABLES.");
        ...
        // uml: / { trace("Transition action `` for TEST6_VARIABLES.InitialState to TEST6_ROOT."); } TransitionTo(TEST6_ROOT)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST6_VARIABLES.InitialState to TEST6_ROOT.");
            ...
            // uml: / { trace("Transition action `` for TEST6_ROOT.InitialState to TEST6_S1."); } TransitionTo(TEST6_S1)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST6_ROOT.InitialState to TEST6_S1.");
                
                // Step 3: Enter/move towards transition target `TEST6_S1`.
                TEST6_S1_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST6_S1;
                // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
                return;
...
private void DECIDE_ev7()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV7 TransitionTo(TEST7_INITIAL_OR_HISTORY)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST7_INITIAL_OR_HISTORY.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST7_INITIAL_OR_HISTORY.");
        ...
        // uml: / { trace("Transition action `` for TEST7_INITIAL_OR_HISTORY.InitialState to TEST7_DECIDE."); } TransitionTo(TEST7_DECIDE)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST7_INITIAL_OR_HISTORY.InitialState to TEST7_DECIDE.");
            
            // Step 3: Enter/move towards transition target `TEST7_DECIDE`.
            TEST7_DECIDE_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST7_DECIDE;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
private void DECIDE_ev8()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV8 TransitionTo(TEST8_ENTRY_CHOICE)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST8_ENTRY_CHOICE.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST8_ENTRY_CHOICE.");
        ...
        // uml: / { trace("Transition action `` for TEST8_ENTRY_CHOICE.InitialState to TEST8_ROOT.EntryPoint(1)."); } TransitionTo(TEST8_ROOT.EntryPoint(1))
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST8_ENTRY_CHOICE.InitialState to TEST8_ROOT.EntryPoint(1).");
...
private void DECIDE_ev9()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State DECIDE: check behavior `EV9 TransitionTo(TEST9_EXIT_CHOICE)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `ROOT` state (Least Common Ancestor for transition).
        DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for DECIDE to TEST9_EXIT_CHOICE.");`.
        //>>>>>ECHO:trace("Transition action `` for DECIDE to TEST9_EXIT_CHOICE.");
        ...
        // uml: / { trace("Transition action `` for TEST9_EXIT_CHOICE.InitialState to TEST9_DECIDE."); } TransitionTo(TEST9_DECIDE)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST9_EXIT_CHOICE.InitialState to TEST9_DECIDE.");
            
            // Step 3: Enter/move towards transition target `TEST9_DECIDE`.
            TEST9_DECIDE_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST9_DECIDE;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__ORDER_MENU_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__ORDER_MENU."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__ORDER_MENU.");
...
private void PREFIXING__ORDER_MENU_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__ORDER_MENU."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__ORDER_MENU.");
    } // end of behavior for PREFIXING__ORDER_MENU
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__BEVERAGE_exit;
    this.current_event_handlers[(int)EventId.EV2] = PREFIXING__OM__BEVERAGE_ev2;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__BEVERAGE."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__BEVERAGE.");
...
private void PREFIXING__OM__BEVERAGE_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__BEVERAGE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__BEVERAGE.");
    } // end of behavior for PREFIXING__OM__BEVERAGE
...
private void PREFIXING__OM__BEVERAGE_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__OM__BEVERAGE: check behavior `EV2 TransitionTo(PREFIXING__OM__VEG)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__ORDER_MENU` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(PREFIXING__ORDER_MENU_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for PREFIXING__OM__BEVERAGE to PREFIXING__OM__VEG.");`.
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__BEVERAGE to PREFIXING__OM__VEG.");
        ...
        // uml: / { trace("Transition action `` for PREFIXING__OM__VEG.InitialState to PREFIXING__OM__VEG__NONE."); } TransitionTo(PREFIXING__OM__VEG__NONE)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__VEG.InitialState to PREFIXING__OM__VEG__NONE.");
            
            // Step 3: Enter/move towards transition target `PREFIXING__OM__VEG__NONE`.
            PREFIXING__OM__VEG__NONE_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.PREFIXING__OM__VEG__NONE;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
private void PREFIXING__OM__BEVERAGE_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for PREFIXING__OM__BEVERAGE.InitialState to PREFIXING__OM__BEV__NONE."); } TransitionTo(PREFIXING__OM__BEV__NONE)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__BEVERAGE.InitialState to PREFIXING__OM__BEV__NONE.");
        
        // Step 3: Enter/move towards transition target `PREFIXING__OM__BEV__NONE`.
        PREFIXING__OM__BEV__NONE_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__OM__BEV__NONE;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__BEV__NONE_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__OM__BEV__NONE_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__BEV__NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__BEV__NONE.");
...
private void PREFIXING__OM__BEV__NONE_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__BEV__NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__BEV__NONE.");
    } // end of behavior for PREFIXING__OM__BEV__NONE
...
private void PREFIXING__OM__BEV__NONE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__OM__BEV__NONE: check behavior `EV1 TransitionTo(PREFIXING__OM__BEV__WATER)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__BEV__NONE to PREFIXING__OM__BEV__WATER.");
        
        // Step 3: Enter/move towards transition target `PREFIXING__OM__BEV__WATER`.
        PREFIXING__OM__BEV__WATER_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__OM__BEV__WATER;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__OM__BEV__NONE
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__BEV__TEA_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__BEV__TEA."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__BEV__TEA.");
...
private void PREFIXING__OM__BEV__TEA_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__BEV__TEA."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__BEV__TEA.");
    } // end of behavior for PREFIXING__OM__BEV__TEA
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__BEV__WATER_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__OM__BEV__WATER_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__BEV__WATER."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__BEV__WATER.");
...
private void PREFIXING__OM__BEV__WATER_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__BEV__WATER."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__BEV__WATER.");
    } // end of behavior for PREFIXING__OM__BEV__WATER
...
private void PREFIXING__OM__BEV__WATER_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__OM__BEV__WATER: check behavior `EV1 TransitionTo(PREFIXING__OM__BEV__TEA)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__OM__BEVERAGE` state (Least Common Ancestor for transition).
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__BEV__WATER to PREFIXING__OM__BEV__TEA.");
        
        // Step 3: Enter/move towards transition target `PREFIXING__OM__BEV__TEA`.
        PREFIXING__OM__BEV__TEA_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__OM__BEV__TEA;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__OM__BEV__WATER
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__VEG_exit;
    this.current_event_handlers[(int)EventId.EV2] = PREFIXING__OM__VEG_ev2;
    
    // PREFIXING__OM__VEG behavior
    // uml: enter / { trace("Enter PREFIXING__OM__VEG."); }
    {
        // Step 1: execute action `trace("Enter PREFIXING__OM__VEG.");`
        //>>>>>ECHO:trace("Enter PREFIXING__OM__VEG.");
...
private void PREFIXING__OM__VEG_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__VEG."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__VEG.");
    } // end of behavior for PREFIXING__OM__VEG
...
private void PREFIXING__OM__VEG_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__OM__VEG: check behavior `EV2 TransitionTo(PREFIXING__OM__BEVERAGE)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__ORDER_MENU` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(PREFIXING__ORDER_MENU_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for PREFIXING__OM__VEG to PREFIXING__OM__BEVERAGE.");`.
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__VEG to PREFIXING__OM__BEVERAGE.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__VEG__NONE_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__OM__VEG__NONE_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__VEG__NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__VEG__NONE.");
...
private void PREFIXING__OM__VEG__NONE_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__VEG__NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__VEG__NONE.");
    } // end of behavior for PREFIXING__OM__VEG__NONE
...
private void PREFIXING__OM__VEG__NONE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__OM__VEG__NONE: check behavior `EV1 TransitionTo(PREFIXING__OM__VEG__POTATO)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__VEG__NONE to PREFIXING__OM__VEG__POTATO.");
        
        // Step 3: Enter/move towards transition target `PREFIXING__OM__VEG__POTATO`.
        PREFIXING__OM__VEG__POTATO_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__OM__VEG__POTATO;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__OM__VEG__NONE
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__VEG__POTATO_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__OM__VEG__POTATO_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__VEG__POTATO."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__VEG__POTATO.");
...
private void PREFIXING__OM__VEG__POTATO_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__VEG__POTATO."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__VEG__POTATO.");
    } // end of behavior for PREFIXING__OM__VEG__POTATO
...
private void PREFIXING__OM__VEG__POTATO_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__OM__VEG__POTATO: check behavior `EV1 TransitionTo(PREFIXING__OM__VEG__YAM)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__OM__VEG` state (Least Common Ancestor for transition).
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__OM__VEG__POTATO to PREFIXING__OM__VEG__YAM.");
        
        // Step 3: Enter/move towards transition target `PREFIXING__OM__VEG__YAM`.
        PREFIXING__OM__VEG__YAM_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__OM__VEG__YAM;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__OM__VEG__POTATO
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__OM__VEG__YAM_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__OM__VEG__YAM."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__OM__VEG__YAM.");
...
private void PREFIXING__OM__VEG__YAM_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__OM__VEG__YAM."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__OM__VEG__YAM.");
    } // end of behavior for PREFIXING__OM__VEG__YAM
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE_exit;
    this.current_event_handlers[(int)EventId.EV2] = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE_ev2;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE: check behavior `EV2 TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU_exit);
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE to PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG.");
        ...
        // uml: / { trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG.InitialState to PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE."); } TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG.InitialState to PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE.");
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE.InitialState to PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE."); } TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE.InitialState to PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE: check behavior `EV1 TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE to PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_NONE
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER: check behavior `EV1 TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE` state (Least Common Ancestor for transition).
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER to PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_TEA;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEV_WATER
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_exit;
    this.current_event_handlers[(int)EventId.EV2] = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_ev2;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG: check behavior `EV2 TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(PREFIXING__SHOWS_MANUAL_PREFIX__ORDER_MENU_exit);
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG to PREFIXING__SHOWS_MANUAL_PREFIX__OM_BEVERAGE.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE: check behavior `EV1 TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE to PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_NONE
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO_exit;
    this.current_event_handlers[(int)EventId.EV1] = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO_ev1;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO: check behavior `EV1 TransitionTo(PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG` state (Least Common Ancestor for transition).
        ...
        //>>>>>ECHO:trace("Transition action `` for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO to PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_POTATO
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM_exit;
    ...
    // uml: enter / { trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM."); }
    {
        ...
        //>>>>>ECHO:trace("Enter PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM.");
...
private void PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM_exit()
{
    ...
    // uml: exit / { trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM."); }
    {
        ...
        //>>>>>ECHO:trace("Exit PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM.");
    } // end of behavior for PREFIXING__SHOWS_MANUAL_PREFIX__OM_VEG_YAM
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST1_DO_EVENT_TESTING_exit;
    ...
    // uml: enter / { trace("Enter TEST1_DO_EVENT_TESTING."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST1_DO_EVENT_TESTING.");
...
private void TEST1_DO_EVENT_TESTING_exit()
{
    ...
    // uml: exit / { trace("Exit TEST1_DO_EVENT_TESTING."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST1_DO_EVENT_TESTING.");
    } // end of behavior for TEST1_DO_EVENT_TESTING
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST1_ROOT_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST1_ROOT_do;
    
    // TEST1_ROOT behavior
    // uml: enter / { trace("Enter TEST1_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST1_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST1_ROOT.");
...
private void TEST1_ROOT_do()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST1_ROOT: check behavior `do`.", true)>>>>>rm2>>>>>*/)
    {
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST1_S1_1_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST1_S1_1_do;
    this.current_event_handlers[(int)EventId.EV1] = TEST1_S1_1_ev1;
    
    // TEST1_S1_1 behavior
    // uml: enter / { trace("Enter TEST1_S1_1."); }
    {
        // Step 1: execute action `trace("Enter TEST1_S1_1.");`
        //>>>>>ECHO:trace("Enter TEST1_S1_1.");
    } // end of behavior for TEST1_S1_1
    
    // TEST1_S1_1 behavior
    // uml: enter [trace_guard("State TEST1_S1_1: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST1_S1_1: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST1_S1_1
}
...
private void TEST1_S1_1_exit()
{
    ...
    // uml: exit / { trace("Exit TEST1_S1_1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST1_S1_1.");
    } // end of behavior for TEST1_S1_1
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = TEST1_S1_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST1_ROOT_do;  // the next ancestor that handles this event is TEST1_ROOT
    this.current_event_handlers[(int)EventId.EV1] = null;  // no ancestor listens to this event
}
...
private void TEST1_S1_1_do()
{
    ...
    this.ancestor_event_handler = TEST1_ROOT_do;
    
    // TEST1_S1_1 behavior
    // uml: do [trace_guard("State TEST1_S1_1: check behavior `do`.", true)]
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST1_S1_1: check behavior `do`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        // Don't consume special `do` event.
...
private void TEST1_S1_1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST1_S1_1: check behavior `EV1 TransitionTo(TEST1_S2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST1_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST1_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST1_S1_1 to TEST1_S2.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST1_S1_1 to TEST1_S2.");
        
        // Step 3: Enter/move towards transition target `TEST1_S2`.
        TEST1_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST1_S2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST1_S1_1
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST1_S2_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST1_S2_do;
    
    // TEST1_S2 behavior
    // uml: enter / { trace("Enter TEST1_S2."); }
    {
        // Step 1: execute action `trace("Enter TEST1_S2.");`
        //>>>>>ECHO:trace("Enter TEST1_S2.");
...
private void TEST1_S2_do()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST1_S2: check behavior `do / { consume_event = true; }`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:consume_event = true;
        
        // Step 2: determine if ancestor gets to handle event next.
        if (consume_event)
        {
            this.ancestor_event_handler = null;  // consume event
        }
    } // end of behavior for TEST1_S2
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST10_CHOICE_POINT_exit;
    ...
    // uml: enter / { trace("Enter TEST10_CHOICE_POINT."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST10_CHOICE_POINT.");
...
private void TEST10_CHOICE_POINT_exit()
{
    ...
    // uml: exit / { trace("Exit TEST10_CHOICE_POINT."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST10_CHOICE_POINT.");
    } // end of behavior for TEST10_CHOICE_POINT
...
private void TEST10_A_ChoicePoint__transition()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST10_A.ChoicePoint() to TEST10_A.ChoicePoint().");
...
private void TEST10_A_ChoicePoint__transition_kid_index3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST10_A.ChoicePoint() to TEST10_A.ChoicePoint(a).");
...
private void TEST10_A_ChoicePoint_a__transition()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST10_A.ChoicePoint(a) to TEST10_A.ChoicePoint(a).");
...
private void TEST10_A_ChoicePoint_a__transition_kid_index5()
{
    ...
    // uml: / { trace("Transition action `` for TEST10_A.ChoicePoint(a) to TEST10_A_1."); } TransitionTo(TEST10_A_1)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST10_A.ChoicePoint(a) to TEST10_A_1.");
        
        // Step 3: Enter/move towards transition target `TEST10_A_1`.
        TEST10_A_1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST10_A_1;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST10_A.ChoicePoint(a)
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST10_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV5] = TEST10_ROOT_ev5;
    
    // TEST10_ROOT behavior
    // uml: enter / { trace("Enter TEST10_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST10_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST10_ROOT.");
...
private void TEST10_ROOT_ev5()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST10_ROOT: check behavior `EV5 / { count++; }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count++;`
        //>>>>>ECHO:self->vars.count++;
...
private void TEST10_G_ChoicePoint__transition()
{
    ...
    // uml: / { trace("Transition action `` for TEST10_G.ChoicePoint() to TEST10_G.ChoicePoint(1)."); } TransitionTo(TEST10_G.ChoicePoint(1))
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint() to TEST10_G.ChoicePoint(1).");
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count <= 0>>>>>rm2>>>>>*/)
        {
            // Step 1: Exit states until we reach `TEST10_G` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `trace("Transition action `` for TEST10_G.ChoicePoint(1) to TEST10_G_S0.");`.
            //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint(1) to TEST10_G_S0.");
            
            // Step 3: Enter/move towards transition target `TEST10_G_S0`.
            TEST10_G_S0_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST10_G_S0;
            this.ancestor_event_handler = null;
            return;
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count <= 2>>>>>rm2>>>>>*/)
        {
            // Step 1: Exit states until we reach `TEST10_G` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `trace("Transition action `` for TEST10_G.ChoicePoint(1) to TEST10_G.ChoicePoint(lower).");`.
            //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint(1) to TEST10_G.ChoicePoint(lower).");
            ...
            if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count <=1>>>>>rm2>>>>>*/)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint(lower) to TEST10_G_S1.");
                
                // Step 3: Enter/move towards transition target `TEST10_G_S1`.
                TEST10_G_S1_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST10_G_S1;
                this.ancestor_event_handler = null;
                return;
            ...
            // uml: else / { trace("Transition action `` for TEST10_G.ChoicePoint(lower) to TEST10_G_S2."); } TransitionTo(TEST10_G_S2)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint(lower) to TEST10_G_S2.");
                
                // Step 3: Enter/move towards transition target `TEST10_G_S2`.
                TEST10_G_S2_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST10_G_S2;
                this.ancestor_event_handler = null;
                return;
            } // end of behavior for TEST10_G.ChoicePoint(lower)
        } // end of behavior for TEST10_G.ChoicePoint(1)
        ...
        // uml: else / { trace("Transition action `` for TEST10_G.ChoicePoint(1) to TEST10_G.ChoicePoint(upper)."); } TransitionTo(TEST10_G.ChoicePoint(upper))
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint(1) to TEST10_G.ChoicePoint(upper).");
            ...
            if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count <= 3>>>>>rm2>>>>>*/)
            {
                // Step 1: Exit states until we reach `TEST10_G` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
                
                // Step 2: Transition action: `trace("Transition action `` for TEST10_G.ChoicePoint(upper) to TEST10_G_S3.");`.
                //>>>>>ECHO:trace("Transition action `` for TEST10_G.ChoicePoint(upper) to TEST10_G_S3.");
                
                // Step 3: Enter/move towards transition target `TEST10_G_S3`.
                TEST10_G_S3_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST10_G_S3;
                this.ancestor_event_handler = null;
                return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST10_S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST10_S1_ev1;
    this.current_event_handlers[(int)EventId.EV10] = TEST10_S1_ev10;
    this.current_event_handlers[(int)EventId.EV2] = TEST10_S1_ev2;
    this.current_event_handlers[(int)EventId.EV3] = TEST10_S1_ev3;
    
    // TEST10_S1 behavior
    // uml: enter / { trace("Enter TEST10_S1."); }
    {
        // Step 1: execute action `trace("Enter TEST10_S1.");`
        //>>>>>ECHO:trace("Enter TEST10_S1.");
    } // end of behavior for TEST10_S1
    
    // TEST10_S1 behavior
    // uml: enter [trace_guard("State TEST10_S1: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST10_S1: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST10_S1
...
private void TEST10_S1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST10_S1: check behavior `EV1 TransitionTo(TEST10_G.EntryPoint(1))`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST10_ROOT` state (Least Common Ancestor for transition).
        TEST10_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST10_S1 to TEST10_G.EntryPoint(1).");`.
        //>>>>>ECHO:trace("Transition action `` for TEST10_S1 to TEST10_G.EntryPoint(1).");
        ...
        // uml: / { trace("Transition action `` for TEST10_G.EntryPoint(1) to TEST10_G.ChoicePoint()."); } TransitionTo(TEST10_G.ChoicePoint())
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST10_G.EntryPoint(1) to TEST10_G.ChoicePoint().");
...
private void TEST10_S1_ev10()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST10_S1: check behavior `EV10 TransitionTo(TEST10_A)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST10_CHOICE_POINT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST10_CHOICE_POINT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST10_S1 to TEST10_A.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST10_S1 to TEST10_A.");
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST10_A.InitialState to TEST10_A.ChoicePoint().");
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 0>>>>>rm2>>>>>*/)
        {
            ...
            //>>>>>ECHO:trace("Transition action `count++;` for TEST10_A.InitialState to TEST10_A.ChoicePoint().");
            //>>>>>ECHO:self->vars.count++;
...
private void TEST10_S1_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST10_S1: check behavior `EV2 TransitionTo(TEST10_G.ChoicePoint())`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST10_ROOT` state (Least Common Ancestor for transition).
        TEST10_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST10_S1 to TEST10_G.ChoicePoint().");`.
        //>>>>>ECHO:trace("Transition action `` for TEST10_S1 to TEST10_G.ChoicePoint().");
...
private void TEST10_S1_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST10_S1: check behavior `EV3 TransitionTo(TEST10_G)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST10_ROOT` state (Least Common Ancestor for transition).
        TEST10_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST10_S1 to TEST10_G.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST10_S1 to TEST10_G.");
        ...
        // uml: / { trace("Transition action `` for TEST10_G.InitialState to TEST10_G.ChoicePoint()."); } TransitionTo(TEST10_G.ChoicePoint())
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST10_G.InitialState to TEST10_G.ChoicePoint().");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST2_REGULAR_EVENT_TESTING_exit;
    ...
    // uml: enter / { trace("Enter TEST2_REGULAR_EVENT_TESTING."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST2_REGULAR_EVENT_TESTING.");
...
private void TEST2_REGULAR_EVENT_TESTING_exit()
{
    ...
    // uml: exit / { trace("Exit TEST2_REGULAR_EVENT_TESTING."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST2_REGULAR_EVENT_TESTING.");
    } // end of behavior for TEST2_REGULAR_EVENT_TESTING
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST2_ROOT_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST2_ROOT_do;
    this.current_event_handlers[(int)EventId.EV1] = TEST2_ROOT_ev1;
    this.current_event_handlers[(int)EventId.EV2] = TEST2_ROOT_ev2;
    
    // TEST2_ROOT behavior
    // uml: enter / { trace("Enter TEST2_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST2_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST2_ROOT.");
...
private void TEST2_ROOT_do()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_ROOT: check behavior `do`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        // Don't consume special `do` event.
...
private void TEST2_ROOT_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_ROOT: check behavior `EV1`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
...
private void TEST2_ROOT_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_ROOT: check behavior `EV2`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST2_S1_1_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST2_S1_1_do;
    this.current_event_handlers[(int)EventId.EV1] = TEST2_S1_1_ev1;
    
    // TEST2_S1_1 behavior
    // uml: enter / { trace("Enter TEST2_S1_1."); }
    {
        // Step 1: execute action `trace("Enter TEST2_S1_1.");`
        //>>>>>ECHO:trace("Enter TEST2_S1_1.");
    } // end of behavior for TEST2_S1_1
    
    // TEST2_S1_1 behavior
    // uml: enter [trace_guard("State TEST2_S1_1: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_S1_1: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST2_S1_1
...
private void TEST2_S1_1_exit()
{
    ...
    // uml: exit / { trace("Exit TEST2_S1_1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST2_S1_1.");
    } // end of behavior for TEST2_S1_1
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = TEST2_S1_exit;
    this.current_event_handlers[(int)EventId.DO] = TEST2_ROOT_do;  // the next ancestor that handles this event is TEST2_ROOT
    this.current_event_handlers[(int)EventId.EV1] = TEST2_ROOT_ev1;  // the next ancestor that handles this event is TEST2_ROOT
}

private void TEST2_S1_1_do()
{
    // Setup handler for next ancestor that listens to `do` event.
    this.ancestor_event_handler = TEST2_ROOT_do;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_S1_1: check behavior `do TransitionTo(TEST2_S2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST2_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST2_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST2_S1_1 to TEST2_S2.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST2_S1_1 to TEST2_S2.");
        
        // Step 3: Enter/move towards transition target `TEST2_S2`.
        TEST2_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST2_S2;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST2_S1_1
}
...
private void TEST2_S1_1_ev1()
{
    ...
    this.ancestor_event_handler = TEST2_ROOT_ev1;
    
    // TEST2_S1_1 behavior
    // uml: EV1 [trace_guard("State TEST2_S1_1: check behavior `EV1`.", true)]
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_S1_1: check behavior `EV1`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        this.ancestor_event_handler = null;  // consume event
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST2_S2_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST2_S2_ev1;
    this.current_event_handlers[(int)EventId.EV2] = TEST2_S2_ev2;
    
    // TEST2_S2 behavior
    // uml: enter / { trace("Enter TEST2_S2."); }
    {
        // Step 1: execute action `trace("Enter TEST2_S2.");`
        //>>>>>ECHO:trace("Enter TEST2_S2.");
...
private void TEST2_S2_exit()
{
    ...
    // uml: exit / { trace("Exit TEST2_S2."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST2_S2.");
    } // end of behavior for TEST2_S2
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = TEST2_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST2_ROOT_ev1;  // the next ancestor that handles this event is TEST2_ROOT
    this.current_event_handlers[(int)EventId.EV2] = TEST2_ROOT_ev2;  // the next ancestor that handles this event is TEST2_ROOT
}
...
private void TEST2_S2_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_S2: check behavior `EV1 / { consume_event = false; }`.", true)>>>>>rm2>>>>>*/)
    {
...
private void TEST2_S2_ev2()
{
    ...
    this.ancestor_event_handler = TEST2_ROOT_ev2;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST2_S2: check behavior `EV2 TransitionTo(TEST2_S2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST2_ROOT` state (Least Common Ancestor for transition).
        TEST2_S2_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST2_S2 to TEST2_S2.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST2_S2 to TEST2_S2.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST3_BEHAVIOR_ORDERING_exit;
    ...
    // uml: enter / { trace("Enter TEST3_BEHAVIOR_ORDERING."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST3_BEHAVIOR_ORDERING.");
...
private void TEST3_BEHAVIOR_ORDERING_exit()
{
    ...
    // uml: exit / { trace("Exit TEST3_BEHAVIOR_ORDERING."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST3_BEHAVIOR_ORDERING.");
    } // end of behavior for TEST3_BEHAVIOR_ORDERING
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST3_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST3_ROOT_ev1;
    
    // TEST3_ROOT behavior
    // uml: enter / { trace("Enter TEST3_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST3_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST3_ROOT.");
...
private void TEST3_ROOT_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_ROOT: check behavior `EV1`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST3_S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST3_S1_ev1;
    
    // TEST3_S1 behavior
    // uml: enter / { trace("Enter TEST3_S1."); }
    {
        // Step 1: execute action `trace("Enter TEST3_S1.");`
        //>>>>>ECHO:trace("Enter TEST3_S1.");
    } // end of behavior for TEST3_S1
    
    // TEST3_S1 behavior
    // uml: enter [trace_guard("State TEST3_S1: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_S1: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST3_S1
...
private void TEST3_S1_exit()
{
    ...
    // uml: exit / { trace("Exit TEST3_S1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST3_S1.");
    } // end of behavior for TEST3_S1
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = TEST3_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST3_ROOT_ev1;  // the next ancestor that handles this event is TEST3_ROOT
}

private void TEST3_S1_ev1()
{
    // Setup handler for next ancestor that listens to `EV1` event.
    this.ancestor_event_handler = TEST3_ROOT_ev1;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_S1: check behavior `1. EV1 TransitionTo(TEST3_S2)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST3_S1 to TEST3_S2.");
        
        // Step 3: Enter/move towards transition target `TEST3_S2`.
        TEST3_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST3_S2;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST3_S1
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_S1: check behavior `2. EV1 / { trace(\"failed\"); }`.", true)>>>>>rm2>>>>>*/)
    {
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST3_S2_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST3_S2_ev1;
    
    // TEST3_S2 behavior
    // uml: enter / { trace("Enter TEST3_S2."); }
    {
        // Step 1: execute action `trace("Enter TEST3_S2.");`
        //>>>>>ECHO:trace("Enter TEST3_S2.");
...
private void TEST3_S2_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_S2: check behavior `1. EV1 / { trace(\"1 woot!\"); }`.", true)>>>>>rm2>>>>>*/)
    {
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_S2: check behavior `1.1. EV1 / { trace(\"2 woot!\"); }`.", true)>>>>>rm2>>>>>*/)
    {
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST3_S2: check behavior `2. EV1 / { trace(\"3 woot!\"); } TransitionTo(TEST3_S3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST3_ROOT` state (Least Common Ancestor for transition).
        TEST3_S2_exit();
        
        // Step 2: Transition action: `trace("Transition action `trace(\"3 woot!\");` for TEST3_S2 to TEST3_S3.");\ntrace("3 woot!");`.
        //>>>>>ECHO:trace("Transition action `trace(\"3 woot!\");` for TEST3_S2 to TEST3_S3.");
        //>>>>>ECHO:trace("3 woot!");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST3_S3;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST3_S2
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_PARENT_CHILD_TRANSITIONS_exit;
    ...
    // uml: enter / { trace("Enter TEST4_PARENT_CHILD_TRANSITIONS."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST4_PARENT_CHILD_TRANSITIONS.");
...
private void TEST4_PARENT_CHILD_TRANSITIONS_exit()
{
    ...
    // uml: exit / { trace("Exit TEST4_PARENT_CHILD_TRANSITIONS."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST4_PARENT_CHILD_TRANSITIONS.");
    } // end of behavior for TEST4_PARENT_CHILD_TRANSITIONS
...
private void TEST4_B_AND_OTHERS_enter()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_B_AND_OTHERS: check behavior `enter / { clear_dispatch_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_dispatch_output();`
        //>>>>>ECHO:trace("CLEAR_OUTPUT_BEFORE_THIS_AND_FOR_THIS_EVENT_DISPATCH");;
    } // end of behavior for TEST4_B_AND_OTHERS
}
...
private void TEST4_B_AND_OTHERS_exit()
{
    ...
    // uml: exit / { trace("Exit TEST4_B_AND_OTHERS."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST4_B_AND_OTHERS.");
    } // end of behavior for TEST4_B_AND_OTHERS
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4B_G_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4B_G_ev1;
    
    // TEST4B_G behavior
    // uml: enter / { trace("Enter TEST4B_G."); }
    {
        // Step 1: execute action `trace("Enter TEST4B_G.");`
        //>>>>>ECHO:trace("Enter TEST4B_G.");
...
private void TEST4B_G_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4B_G: check behavior `EV1 TransitionTo(TEST4B_G_1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4B_G` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4B_G_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4B_G to TEST4B_G_1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4B_G to TEST4B_G_1.");
        
        // Step 3: Enter/move towards transition target `TEST4B_G_1`.
        TEST4B_G_1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4B_G_1;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4B_G
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4B_G_1_exit;
    this.current_event_handlers[(int)EventId.EV2] = TEST4B_G_1_ev2;
    
    // TEST4B_G_1 behavior
    // uml: enter / { trace("Enter TEST4B_G_1."); }
    {
        // Step 1: execute action `trace("Enter TEST4B_G_1.");`
        //>>>>>ECHO:trace("Enter TEST4B_G_1.");
...
private void TEST4B_G_1_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4B_G_1: check behavior `EV2 TransitionTo(TEST4B_G)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4B_G` state (Least Common Ancestor for transition).
        TEST4B_G_1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4B_G_1 to TEST4B_G.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4B_G_1 to TEST4B_G.");
        
        // Step 3: Enter/move towards transition target `TEST4B_G`.
        // Already in target. No entering required.
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4B_G;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4B_G_1
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4C_LOCAL_TO_ALIAS_exit;
    ...
    // uml: enter / { trace("Enter TEST4C_LOCAL_TO_ALIAS."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST4C_LOCAL_TO_ALIAS.");
...
private void TEST4C_LOCAL_TO_ALIAS_exit()
{
    ...
    // uml: exit / { trace("Exit TEST4C_LOCAL_TO_ALIAS."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST4C_LOCAL_TO_ALIAS.");
    } // end of behavior for TEST4C_LOCAL_TO_ALIAS
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4C_G_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4C_G_ev1;
    
    // TEST4C_G behavior
    // uml: enter / { trace("Enter TEST4C_G."); }
    {
        // Step 1: execute action `trace("Enter TEST4C_G.");`
        //>>>>>ECHO:trace("Enter TEST4C_G.");
...
private void TEST4C_G_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4C_G: check behavior `EV1 TransitionTo(TEST4C_G_1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4C_G` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4C_G_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4C_G to TEST4C_G_1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4C_G to TEST4C_G_1.");
        
        // Step 3: Enter/move towards transition target `TEST4C_G_1`.
        TEST4C_G_1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4C_G_1;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4C_G
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4C_G_1_exit;
    this.current_event_handlers[(int)EventId.EV2] = TEST4C_G_1_ev2;
    
    // TEST4C_G_1 behavior
    // uml: enter / { trace("Enter TEST4C_G_1."); }
    {
        // Step 1: execute action `trace("Enter TEST4C_G_1.");`
        //>>>>>ECHO:trace("Enter TEST4C_G_1.");
...
private void TEST4C_G_1_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4C_G_1: check behavior `EV2 TransitionTo(TEST4C_G)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4C_G` state (Least Common Ancestor for transition).
        TEST4C_G_1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4C_G_1 to TEST4C_G.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4C_G_1 to TEST4C_G.");
        
        // Step 3: Enter/move towards transition target `TEST4C_G`.
        // Already in target. No entering required.
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4C_G;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4C_G_1
}
...
private void TEST4D_EXTERNAL_exit()
{
    ...
    // uml: exit / { trace("Exit TEST4D_EXTERNAL."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST4D_EXTERNAL.");
    } // end of behavior for TEST4D_EXTERNAL
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4D_G_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4D_G_ev1;
    
    // TEST4D_G behavior
    // uml: enter / { trace("Enter TEST4D_G."); }
    {
        // Step 1: execute action `trace("Enter TEST4D_G.");`
        //>>>>>ECHO:trace("Enter TEST4D_G.");
...
private void TEST4D_G_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4D_G: check behavior `EV1 TransitionTo(TEST4D_EXTERNAL.ChoicePoint())`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4D_EXTERNAL` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4D_EXTERNAL_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4D_G to TEST4D_EXTERNAL.ChoicePoint().");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4D_G to TEST4D_EXTERNAL.ChoicePoint().");
        ...
        // uml: / { trace("Transition action `` for TEST4D_EXTERNAL.ChoicePoint() to TEST4D_G_1."); } TransitionTo(TEST4D_G_1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST4D_EXTERNAL.ChoicePoint() to TEST4D_G_1.");
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST4D_G_1;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4D_G_1_exit;
    this.current_event_handlers[(int)EventId.EV2] = TEST4D_G_1_ev2;
    
    // TEST4D_G_1 behavior
    // uml: enter / { trace("Enter TEST4D_G_1."); }
    {
        // Step 1: execute action `trace("Enter TEST4D_G_1.");`
        //>>>>>ECHO:trace("Enter TEST4D_G_1.");
...
private void TEST4D_G_1_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4D_G_1: check behavior `EV2 TransitionTo(TEST4D_EXTERNAL.ChoicePoint())`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4D_EXTERNAL` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4D_EXTERNAL_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4D_G_1 to TEST4D_EXTERNAL.ChoicePoint().");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4D_G_1 to TEST4D_EXTERNAL.ChoicePoint().");
        ...
        // uml: / { trace("Transition action `` for TEST4D_EXTERNAL.ChoicePoint() to TEST4D_G."); } TransitionTo(TEST4D_G)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST4D_EXTERNAL.ChoicePoint() to TEST4D_G.");
            
            // Step 3: Enter/move towards transition target `TEST4D_G`.
            TEST4D_G_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST4D_G;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
        } // end of behavior for TEST4D_EXTERNAL.ChoicePoint()
    } // end of behavior for TEST4D_G_1
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_DECIDE_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4_DECIDE_ev1;
    this.current_event_handlers[(int)EventId.EV2] = TEST4_DECIDE_ev2;
    this.current_event_handlers[(int)EventId.EV3] = TEST4_DECIDE_ev3;
    this.current_event_handlers[(int)EventId.EV4] = TEST4_DECIDE_ev4;
    
    // TEST4_DECIDE behavior
    // uml: enter / { trace("Enter TEST4_DECIDE."); }
    {
        // Step 1: execute action `trace("Enter TEST4_DECIDE.");`
        //>>>>>ECHO:trace("Enter TEST4_DECIDE.");
...
private void TEST4_DECIDE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_DECIDE: check behavior `EV1 TransitionTo(TEST4_ROOT)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST4_DECIDE to TEST4_ROOT.");
        
        // Step 3: Enter/move towards transition target `TEST4_ROOT`.
        TEST4_ROOT_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_ROOT;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4_DECIDE
}
...
private void TEST4_DECIDE_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_DECIDE: check behavior `EV2 TransitionTo(TEST4B_LOCAL)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_PARENT_CHILD_TRANSITIONS` state (Least Common Ancestor for transition).
        TEST4_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_DECIDE to TEST4B_LOCAL.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_DECIDE to TEST4B_LOCAL.");
        ...
        // uml: / { trace("Transition action `` for TEST4B_LOCAL.InitialState to TEST4B_G."); } TransitionTo(TEST4B_G)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST4B_LOCAL.InitialState to TEST4B_G.");
...
private void TEST4_DECIDE_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_DECIDE: check behavior `EV3 TransitionTo(TEST4C_LOCAL_TO_ALIAS)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_PARENT_CHILD_TRANSITIONS` state (Least Common Ancestor for transition).
        TEST4_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_DECIDE to TEST4C_LOCAL_TO_ALIAS.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_DECIDE to TEST4C_LOCAL_TO_ALIAS.");
        ...
        // uml: / { trace("Transition action `` for TEST4C_LOCAL_TO_ALIAS.InitialState to TEST4C_G."); } TransitionTo(TEST4C_G)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST4C_LOCAL_TO_ALIAS.InitialState to TEST4C_G.");
...
private void TEST4_DECIDE_ev4()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_DECIDE: check behavior `EV4 TransitionTo(TEST4D_EXTERNAL)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_PARENT_CHILD_TRANSITIONS` state (Least Common Ancestor for transition).
        TEST4_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_DECIDE to TEST4D_EXTERNAL.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_DECIDE to TEST4D_EXTERNAL.");
        ...
        // uml: / { trace("Transition action `` for TEST4D_EXTERNAL.InitialState to TEST4D_G."); } TransitionTo(TEST4D_G)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST4D_EXTERNAL.InitialState to TEST4D_G.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV2] = TEST4_ROOT_ev2;
    this.current_event_handlers[(int)EventId.EV3] = TEST4_ROOT_ev3;
    this.current_event_handlers[(int)EventId.EV4] = TEST4_ROOT_ev4;
    
    // TEST4_ROOT behavior
    // uml: enter / { trace("Enter TEST4_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST4_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST4_ROOT.");
    } // end of behavior for TEST4_ROOT
    
    // TEST4_ROOT behavior
    // uml: enter [trace_guard("State TEST4_ROOT: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_ROOT: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST4_ROOT
...
private void TEST4_ROOT_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_ROOT: check behavior `EV2 TransitionTo(TEST4_S1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_ROOT to TEST4_S1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_ROOT to TEST4_S1.");
        
        // Step 3: Enter/move towards transition target `TEST4_S1`.
        TEST4_S1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_S1;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4_ROOT
}
...
private void TEST4_ROOT_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_ROOT: check behavior `EV3 TransitionTo(TEST4_S10_1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_ROOT to TEST4_S10_1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_ROOT to TEST4_S10_1.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_S10_1;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4_ROOT
}
...
private void TEST4_ROOT_ev4()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_ROOT: check behavior `EV4 TransitionTo(TEST4_S20)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_ROOT to TEST4_S20.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_ROOT to TEST4_S20.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4_S1_ev1;
    
    // TEST4_S1 behavior
    // uml: enter / { trace("Enter TEST4_S1."); }
    {
        // Step 1: execute action `trace("Enter TEST4_S1.");`
        //>>>>>ECHO:trace("Enter TEST4_S1.");
...
private void TEST4_S1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_S1: check behavior `EV1 TransitionTo(TEST4_S2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        TEST4_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_S1 to TEST4_S2.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_S1 to TEST4_S2.");
        
        // Step 3: Enter/move towards transition target `TEST4_S2`.
        TEST4_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_S2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4_S1
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_S10_exit;
    this.current_event_handlers[(int)EventId.EV4] = TEST4_S10_ev4;
    
    // TEST4_S10 behavior
    // uml: enter / { trace("Enter TEST4_S10."); }
    {
        // Step 1: execute action `trace("Enter TEST4_S10.");`
        //>>>>>ECHO:trace("Enter TEST4_S10.");
...
private void TEST4_S10_exit()
{
    ...
    // uml: exit / { trace("Exit TEST4_S10."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST4_S10.");
    } // end of behavior for TEST4_S10
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = TEST4_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV4] = TEST4_ROOT_ev4;  // the next ancestor that handles this event is TEST4_ROOT
}

private void TEST4_S10_ev4()
{
    // Setup handler for next ancestor that listens to `EV4` event.
    this.ancestor_event_handler = TEST4_ROOT_ev4;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_S10: check behavior `EV4 TransitionTo(TEST4_S10)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_S10 to TEST4_S10.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_S10 to TEST4_S10.");
        
        // Step 3: Enter/move towards transition target `TEST4_S10`.
        TEST4_S10_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_S10;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST4_S10
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_S2_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4_S2_ev1;
    
    // TEST4_S2 behavior
    // uml: enter / { trace("Enter TEST4_S2."); }
    {
        // Step 1: execute action `trace("Enter TEST4_S2.");`
        //>>>>>ECHO:trace("Enter TEST4_S2.");
...
private void TEST4_S2_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_S2: check behavior `EV1 TransitionTo(TEST4_S3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        TEST4_S2_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_S2 to TEST4_S3.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_S2 to TEST4_S3.");
        
        // Step 3: Enter/move towards transition target `TEST4_S3`.
        TEST4_S3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_S3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST4_S2
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_S20_exit;
    this.current_event_handlers[(int)EventId.EV4] = TEST4_S20_ev4;
    
    // TEST4_S20 behavior
    // uml: enter / { trace("Enter TEST4_S20."); }
    {
        // Step 1: execute action `trace("Enter TEST4_S20.");`
        //>>>>>ECHO:trace("Enter TEST4_S20.");
...
private void TEST4_S20_ev4()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_S20: check behavior `EV4 TransitionTo(TEST4_S20)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST4_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_S20 to TEST4_S20.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_S20 to TEST4_S20.");
...
private void TEST4_S20_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for TEST4_S20.InitialState to TEST4_S20_1."); } TransitionTo(TEST4_S20_1)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST4_S20.InitialState to TEST4_S20_1.");
        
        // Step 3: Enter/move towards transition target `TEST4_S20_1`.
        TEST4_S20_1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST4_S20_1;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST4_S3_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST4_S3_ev1;
    
    // TEST4_S3 behavior
    // uml: enter / { trace("Enter TEST4_S3."); }
    {
        // Step 1: execute action `trace("Enter TEST4_S3.");`
        //>>>>>ECHO:trace("Enter TEST4_S3.");
...
private void TEST4_S3_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST4_S3: check behavior `EV1 TransitionTo(TEST4_ROOT)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST4_ROOT` state (Least Common Ancestor for transition).
        TEST4_S3_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST4_S3 to TEST4_ROOT.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST4_S3 to TEST4_ROOT.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST5_PARENT_CHILD_TRANSITIONS_ALIAS_exit;
    ...
    // uml: enter / { trace("Enter TEST5_PARENT_CHILD_TRANSITIONS_ALIAS."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST5_PARENT_CHILD_TRANSITIONS_ALIAS.");
...
private void TEST5_PARENT_CHILD_TRANSITIONS_ALIAS_exit()
{
    ...
    // uml: exit / { trace("Exit TEST5_PARENT_CHILD_TRANSITIONS_ALIAS."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST5_PARENT_CHILD_TRANSITIONS_ALIAS.");
    } // end of behavior for TEST5_PARENT_CHILD_TRANSITIONS_ALIAS
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST5_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV2] = TEST5_ROOT_ev2;
    
    // TEST5_ROOT behavior
    // uml: enter / { trace("Enter TEST5_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST5_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST5_ROOT.");
    } // end of behavior for TEST5_ROOT
    
    // TEST5_ROOT behavior
    // uml: enter [trace_guard("State TEST5_ROOT: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST5_ROOT: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST5_ROOT
...
private void TEST5_ROOT_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST5_ROOT: check behavior `EV2 TransitionTo(TEST5_S1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST5_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST5_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST5_ROOT to TEST5_S1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST5_ROOT to TEST5_S1.");
        
        // Step 3: Enter/move towards transition target `TEST5_S1`.
        TEST5_S1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST5_S1;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST5_ROOT
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST5_S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST5_S1_ev1;
    
    // TEST5_S1 behavior
    // uml: enter / { trace("Enter TEST5_S1."); }
    {
        // Step 1: execute action `trace("Enter TEST5_S1.");`
        //>>>>>ECHO:trace("Enter TEST5_S1.");
...
private void TEST5_S1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST5_S1: check behavior `EV1 TransitionTo(TEST5_S2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST5_ROOT` state (Least Common Ancestor for transition).
        TEST5_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST5_S1 to TEST5_S2.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST5_S1 to TEST5_S2.");
        
        // Step 3: Enter/move towards transition target `TEST5_S2`.
        TEST5_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST5_S2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST5_S1
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST5_S2_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST5_S2_ev1;
    
    // TEST5_S2 behavior
    // uml: enter / { trace("Enter TEST5_S2."); }
    {
        // Step 1: execute action `trace("Enter TEST5_S2.");`
        //>>>>>ECHO:trace("Enter TEST5_S2.");
...
private void TEST5_S2_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST5_S2: check behavior `EV1 TransitionTo(TEST5_S3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST5_ROOT` state (Least Common Ancestor for transition).
        TEST5_S2_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST5_S2 to TEST5_S3.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST5_S2 to TEST5_S3.");
        
        // Step 3: Enter/move towards transition target `TEST5_S3`.
        TEST5_S3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST5_S3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST5_S2
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST5_S3_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST5_S3_ev1;
    
    // TEST5_S3 behavior
    // uml: enter / { trace("Enter TEST5_S3."); }
    {
        // Step 1: execute action `trace("Enter TEST5_S3.");`
        //>>>>>ECHO:trace("Enter TEST5_S3.");
...
private void TEST5_S3_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST5_S3: check behavior `EV1 TransitionTo(TEST5_ROOT)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST5_ROOT` state (Least Common Ancestor for transition).
        TEST5_S3_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST5_S3 to TEST5_ROOT.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST5_S3 to TEST5_ROOT.");
...
private void TEST6_VARIABLES_exit()
{
    ...
    // uml: exit / { trace("Exit TEST6_VARIABLES."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST6_VARIABLES.");
    } // end of behavior for TEST6_VARIABLES
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST6_S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST6_S1_ev1;
    
    // TEST6_S1 behavior
    // uml: enter / { trace("Enter TEST6_S1."); }
    {
        // Step 1: execute action `trace("Enter TEST6_S1.");`
        //>>>>>ECHO:trace("Enter TEST6_S1.");
    } // end of behavior for TEST6_S1
    
    // TEST6_S1 behavior
    // uml: enter [trace_guard("State TEST6_S1: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST6_S1: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST6_S1
...
private void TEST6_S1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST6_S1: check behavior `1. EV1 / { count++; }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count++;`
        //>>>>>ECHO:self->vars.count++;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST6_S1: check behavior `2. EV1 [count >= 2] TransitionTo(TEST6_S2)`.", self->vars.count >= 2)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST6_S1 to TEST6_S2.");
        
        // Step 3: Enter/move towards transition target `TEST6_S2`.
        TEST6_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST6_S2;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for TEST6_S1
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST7_INITIAL_OR_HISTORY_exit;
    ...
    // uml: enter / { trace("Enter TEST7_INITIAL_OR_HISTORY."); }
    {
        ...
        //>>>>>ECHO:trace("Enter TEST7_INITIAL_OR_HISTORY.");
...
private void TEST7_INITIAL_OR_HISTORY_exit()
{
    ...
    // uml: exit / { trace("Exit TEST7_INITIAL_OR_HISTORY."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST7_INITIAL_OR_HISTORY.");
    } // end of behavior for TEST7_INITIAL_OR_HISTORY
...
private void TEST7_enter()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7: check behavior `enter / { clear_dispatch_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_dispatch_output();`
        //>>>>>ECHO:trace("CLEAR_OUTPUT_BEFORE_THIS_AND_FOR_THIS_EVENT_DISPATCH");;
    } // end of behavior for TEST7
...
private void T7__DEEP_HISTORY1_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DEEP_HISTORY1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DEEP_HISTORY1.");
    } // end of behavior for T7__DEEP_HISTORY1
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__SANTAS_WORKSHOP_exit;
    ...
    // uml: enter / { trace("Enter T7__DH1__SANTAS_WORKSHOP."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__SANTAS_WORKSHOP.");
...
private void T7__DH1__SANTAS_WORKSHOP_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__SANTAS_WORKSHOP."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__SANTAS_WORKSHOP.");
    } // end of behavior for T7__DH1__SANTAS_WORKSHOP
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__ALIENS_DETECTED_exit;
    this.current_event_handlers[(int)EventId.EV8] = T7__DH1__ALIENS_DETECTED_ev8;
    ...
    // uml: enter / { trace("Enter T7__DH1__ALIENS_DETECTED."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__ALIENS_DETECTED.");
...
private void T7__DH1__ALIENS_DETECTED_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__ALIENS_DETECTED."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__ALIENS_DETECTED.");
    } // end of behavior for T7__DH1__ALIENS_DETECTED
...
private void T7__DH1__ALIENS_DETECTED_ev8()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__ALIENS_DETECTED: check behavior `EV8 TransitionTo(T7__DH1__BUILD)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__SANTAS_WORKSHOP` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH1__SANTAS_WORKSHOP_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__ALIENS_DETECTED to T7__DH1__BUILD.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__ALIENS_DETECTED to T7__DH1__BUILD.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__GET_BACKUP_exit;
    ...
    // uml: enter / { trace("Enter T7__DH1__GET_BACKUP."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__GET_BACKUP.");
...
private void T7__DH1__GET_BACKUP_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__GET_BACKUP."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__GET_BACKUP.");
    } // end of behavior for T7__DH1__GET_BACKUP
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__HERO_exit;
    
    // T7__DH1__HERO behavior
    // uml: enter / { trace("Enter T7__DH1__HERO."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__HERO.");`
        //>>>>>ECHO:trace("Enter T7__DH1__HERO.");
    } // end of behavior for T7__DH1__HERO
    
    // T7__DH1__HERO behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__HERO: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__HERO; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__HERO; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__HERO: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__HERO; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
    ...
    // T7__DH1__HERO behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__HERO: check behavior `enter / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__HERO; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__HERO; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__HERO: check behavior `enter / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__HERO; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__HERO_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH1__HERO.InitialState to T7__DH1__CALL_THOR."); } TransitionTo(T7__DH1__CALL_THOR)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__HERO.InitialState to T7__DH1__CALL_THOR.");
        
        // Step 3: Enter/move towards transition target `T7__DH1__CALL_THOR`.
        T7__DH1__CALL_THOR_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH1__CALL_THOR;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__CALL_BATMAN_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__CALL_BATMAN_ev1;
    ...
    // uml: enter / { trace("Enter T7__DH1__CALL_BATMAN."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__CALL_BATMAN.");
...
private void T7__DH1__CALL_BATMAN_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__CALL_BATMAN."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__CALL_BATMAN.");
    } // end of behavior for T7__DH1__CALL_BATMAN
...
private void T7__DH1__CALL_BATMAN_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__CALL_BATMAN: check behavior `EV1 TransitionTo(T7__DH1__BUDDY_ELF)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__GET_BACKUP` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH1__GET_BACKUP_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__CALL_BATMAN to T7__DH1__BUDDY_ELF.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__CALL_BATMAN to T7__DH1__BUDDY_ELF.");
        ...
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH1__BUDDY_ELF;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH1__CALL_BATMAN
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__CALL_THOR_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__CALL_THOR_ev1;
    
    // T7__DH1__CALL_THOR behavior
    // uml: enter / { trace("Enter T7__DH1__CALL_THOR."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__CALL_THOR.");`
        //>>>>>ECHO:trace("Enter T7__DH1__CALL_THOR.");
...
private void T7__DH1__CALL_THOR_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__CALL_THOR."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__CALL_THOR.");
    } // end of behavior for T7__DH1__CALL_THOR
...
private void T7__DH1__CALL_THOR_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__CALL_THOR: check behavior `EV1 TransitionTo(T7__DH1__CALL_BATMAN)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__CALL_THOR to T7__DH1__CALL_BATMAN.");
        
        // Step 3: Enter/move towards transition target `T7__DH1__CALL_BATMAN`.
        T7__DH1__CALL_BATMAN_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH1__CALL_BATMAN;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH1__CALL_THOR
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__LOCAL_HELP_exit;
    ...
    // uml: enter / { trace("Enter T7__DH1__LOCAL_HELP."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__LOCAL_HELP.");
...
private void T7__DH1__LOCAL_HELP_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__LOCAL_HELP."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__LOCAL_HELP.");
    } // end of behavior for T7__DH1__LOCAL_HELP
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__BUDDY_ELF_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__BUDDY_ELF_ev1;
    
    // T7__DH1__BUDDY_ELF behavior
    // uml: enter / { trace("Enter T7__DH1__BUDDY_ELF."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__BUDDY_ELF.");`
        //>>>>>ECHO:trace("Enter T7__DH1__BUDDY_ELF.");
    } // end of behavior for T7__DH1__BUDDY_ELF
    
    // T7__DH1__BUDDY_ELF behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUDDY_ELF: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__BUDDY_ELF; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__BUDDY_ELF; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUDDY_ELF: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__BUDDY_ELF; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
    ...
    // T7__DH1__BUDDY_ELF behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUDDY_ELF: check behavior `enter / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__BUDDY_ELF; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__BUDDY_ELF; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUDDY_ELF: check behavior `enter / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__BUDDY_ELF; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__BUDDY_ELF_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__BUDDY_ELF."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__BUDDY_ELF.");
    } // end of behavior for T7__DH1__BUDDY_ELF
...
private void T7__DH1__BUDDY_ELF_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUDDY_ELF: check behavior `EV1 TransitionTo(T7__DH1__POLAR_BEARS)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__BUDDY_ELF to T7__DH1__POLAR_BEARS.");
        
        // Step 3: Enter/move towards transition target `T7__DH1__POLAR_BEARS`.
        T7__DH1__POLAR_BEARS_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH1__POLAR_BEARS;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH1__BUDDY_ELF
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__POLAR_BEARS_exit;
    ...
    // uml: enter / { trace("Enter T7__DH1__POLAR_BEARS."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__POLAR_BEARS.");
    } // end of behavior for T7__DH1__POLAR_BEARS
    
    // T7__DH1__POLAR_BEARS behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__POLAR_BEARS: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__POLAR_BEARS; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__POLAR_BEARS; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__POLAR_BEARS: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__POLAR_BEARS; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
    ...
    // T7__DH1__POLAR_BEARS behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__POLAR_BEARS: check behavior `enter / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__POLAR_BEARS; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__POLAR_BEARS; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__POLAR_BEARS: check behavior `enter / { this.vars.T7__DH1__GET_BACKUP_history = T7__DH1__GET_BACKUP_HistoryId.T7__DH1__POLAR_BEARS; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__POLAR_BEARS_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__POLAR_BEARS."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__POLAR_BEARS.");
    } // end of behavior for T7__DH1__POLAR_BEARS
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__GIVE_COOKIES_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__GIVE_COOKIES_ev1;
    ...
    // uml: enter / { trace("Enter T7__DH1__GIVE_COOKIES."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__GIVE_COOKIES.");
    } // end of behavior for T7__DH1__GIVE_COOKIES
    
    // T7__DH1__GIVE_COOKIES behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__GIVE_COOKIES: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__GIVE_COOKIES; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__GIVE_COOKIES; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__GIVE_COOKIES: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__GIVE_COOKIES; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__GIVE_COOKIES_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__GIVE_COOKIES."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__GIVE_COOKIES.");
    } // end of behavior for T7__DH1__GIVE_COOKIES
...
private void T7__DH1__GIVE_COOKIES_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__GIVE_COOKIES: check behavior `EV1 TransitionTo(T7__DH1__CALL_THOR)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__GIVE_COOKIES to T7__DH1__CALL_THOR.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__SNOWBALL_FIGHT_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__SNOWBALL_FIGHT_ev1;
    ...
    // uml: enter / { trace("Enter T7__DH1__SNOWBALL_FIGHT."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__SNOWBALL_FIGHT.");
    } // end of behavior for T7__DH1__SNOWBALL_FIGHT
    
    // T7__DH1__SNOWBALL_FIGHT behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__SNOWBALL_FIGHT: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__SNOWBALL_FIGHT; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__SNOWBALL_FIGHT; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__SNOWBALL_FIGHT: check behavior `enter / { this.vars.T7__DH1__ALIENS_DETECTED_history = T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__SNOWBALL_FIGHT; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__SNOWBALL_FIGHT_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__SNOWBALL_FIGHT."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__SNOWBALL_FIGHT.");
    } // end of behavior for T7__DH1__SNOWBALL_FIGHT
...
private void T7__DH1__SNOWBALL_FIGHT_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__SNOWBALL_FIGHT: check behavior `EV1 TransitionTo(T7__DH1__GIVE_COOKIES)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__ALIENS_DETECTED` state (Least Common Ancestor for transition).
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__SNOWBALL_FIGHT to T7__DH1__GIVE_COOKIES.");
        
        // Step 3: Enter/move towards transition target `T7__DH1__GIVE_COOKIES`.
        T7__DH1__GIVE_COOKIES_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH1__GIVE_COOKIES;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH1__SNOWBALL_FIGHT
}
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__BUILD_exit;
    this.current_event_handlers[(int)EventId.EV6] = T7__DH1__BUILD_ev6;
    this.current_event_handlers[(int)EventId.EV7] = T7__DH1__BUILD_ev7;
    
    // T7__DH1__BUILD behavior
    // uml: enter / { trace("Enter T7__DH1__BUILD."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__BUILD.");`
        //>>>>>ECHO:trace("Enter T7__DH1__BUILD.");
...
private void T7__DH1__BUILD_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__BUILD."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__BUILD.");
    } // end of behavior for T7__DH1__BUILD
...
private void T7__DH1__BUILD_ev6()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUILD: check behavior `EV6 TransitionTo(T7__DH1__ALIENS_DETECTED)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__SANTAS_WORKSHOP` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH1__SANTAS_WORKSHOP_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__BUILD to T7__DH1__ALIENS_DETECTED.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__BUILD to T7__DH1__ALIENS_DETECTED.");
        ...
        // uml: / { trace("Transition action `` for T7__DH1__ALIENS_DETECTED.InitialState to T7__DH1__ALIENS_DETECTED.History."); } TransitionTo(T7__DH1__ALIENS_DETECTED.History)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DH1__ALIENS_DETECTED.InitialState to T7__DH1__ALIENS_DETECTED.History.");
            ...
            // uml: [this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__GIVE_COOKIES] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__GIVE_COOKIES.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__GIVE_COOKIES)
            if (this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__GIVE_COOKIES)
            {
                // Step 1: Exit states until we reach `T7__DH1__ALIENS_DETECTED` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
                
                // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__GIVE_COOKIES.");>>>>>rm2>>>>>*/`.
                /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__GIVE_COOKIES.");>>>>>rm2>>>>>*/
            ...
            // T7__DH1__ALIENS_DETECTED.History behavior
            // uml: [this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__HERO] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__HERO.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__HERO)
            if (this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__HERO)
            {
                // Step 1: Exit states until we reach `T7__DH1__ALIENS_DETECTED` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
                
                // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__HERO.");>>>>>rm2>>>>>*/`.
                /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__HERO.");>>>>>rm2>>>>>*/
            ...
            // T7__DH1__ALIENS_DETECTED.History behavior
            // uml: [this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__BUDDY_ELF] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__BUDDY_ELF.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__BUDDY_ELF)
            if (this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__BUDDY_ELF)
            {
                // Step 1: Exit states until we reach `T7__DH1__ALIENS_DETECTED` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
                
                // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__BUDDY_ELF.");>>>>>rm2>>>>>*/`.
                /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__BUDDY_ELF.");>>>>>rm2>>>>>*/
            ...
            // T7__DH1__ALIENS_DETECTED.History behavior
            // uml: [this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__POLAR_BEARS] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__POLAR_BEARS.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__POLAR_BEARS)
            if (this.vars.T7__DH1__ALIENS_DETECTED_history == T7__DH1__ALIENS_DETECTED_HistoryId.T7__DH1__POLAR_BEARS)
            {
                // Step 1: Exit states until we reach `T7__DH1__ALIENS_DETECTED` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
                
                // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__POLAR_BEARS.");>>>>>rm2>>>>>*/`.
                /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__POLAR_BEARS.");>>>>>rm2>>>>>*/
            ...
            // uml: else / { trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__SNOWBALL_FIGHT."); } TransitionTo(T7__DH1__SNOWBALL_FIGHT)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for T7__DH1__ALIENS_DETECTED.History to T7__DH1__SNOWBALL_FIGHT.");
                
                // Step 3: Enter/move towards transition target `T7__DH1__SNOWBALL_FIGHT`.
                T7__DH1__SNOWBALL_FIGHT_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.T7__DH1__SNOWBALL_FIGHT;
                // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
                return;
            } // end of behavior for T7__DH1__ALIENS_DETECTED.History
...
private void T7__DH1__BUILD_ev7()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BUILD: check behavior `EV7 TransitionTo(T7__DH1__GET_BACKUP.History)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__SANTAS_WORKSHOP` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH1__SANTAS_WORKSHOP_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__BUILD to T7__DH1__GET_BACKUP.History.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__BUILD to T7__DH1__GET_BACKUP.History.");
        ...
        // uml: [this.vars.T7__DH1__GET_BACKUP_history == T7__DH1__GET_BACKUP_HistoryId.T7__DH1__HERO] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__HERO.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__HERO)
        if (this.vars.T7__DH1__GET_BACKUP_history == T7__DH1__GET_BACKUP_HistoryId.T7__DH1__HERO)
        {
            ...
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__HERO.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__HERO.");>>>>>rm2>>>>>*/
        ...
        // T7__DH1__GET_BACKUP.History behavior
        // uml: [this.vars.T7__DH1__GET_BACKUP_history == T7__DH1__GET_BACKUP_HistoryId.T7__DH1__BUDDY_ELF] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__BUDDY_ELF.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__BUDDY_ELF)
        if (this.vars.T7__DH1__GET_BACKUP_history == T7__DH1__GET_BACKUP_HistoryId.T7__DH1__BUDDY_ELF)
        {
            // Step 1: Exit states until we reach `T7__DH1__GET_BACKUP` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__BUDDY_ELF.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__BUDDY_ELF.");>>>>>rm2>>>>>*/
        ...
        // T7__DH1__GET_BACKUP.History behavior
        // uml: [this.vars.T7__DH1__GET_BACKUP_history == T7__DH1__GET_BACKUP_HistoryId.T7__DH1__POLAR_BEARS] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__POLAR_BEARS.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__POLAR_BEARS)
        if (this.vars.T7__DH1__GET_BACKUP_history == T7__DH1__GET_BACKUP_HistoryId.T7__DH1__POLAR_BEARS)
        {
            // Step 1: Exit states until we reach `T7__DH1__GET_BACKUP` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__POLAR_BEARS.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__POLAR_BEARS.");>>>>>rm2>>>>>*/
        ...
        // uml: else / { trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__GET_BACKUP.ChoicePoint()."); } TransitionTo(T7__DH1__GET_BACKUP.ChoicePoint())
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DH1__GET_BACKUP.History to T7__DH1__GET_BACKUP.ChoicePoint().");
            ...
            // uml: / { trace("Transition action `` for T7__DH1__GET_BACKUP.ChoicePoint() to T7__DH1__HERO."); } TransitionTo(T7__DH1__HERO)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for T7__DH1__GET_BACKUP.ChoicePoint() to T7__DH1__HERO.");
...
private void T7__DH1__BUILD_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH1__BUILD.InitialState to T7__DH1__BUILD.History."); } TransitionTo(T7__DH1__BUILD.History)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__BUILD.InitialState to T7__DH1__BUILD.History.");
        ...
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__TOOL] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TOOL.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__TOOL)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__TOOL)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TOOL.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TOOL.");>>>>>rm2>>>>>*/
        ...
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__RACE_CAR] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__RACE_CAR.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__RACE_CAR)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__RACE_CAR)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__RACE_CAR.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__RACE_CAR.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__RACE_CAR;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__TEDDY_BEAR] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TEDDY_BEAR.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__TEDDY_BEAR)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__TEDDY_BEAR)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TEDDY_BEAR.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TEDDY_BEAR.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__TEDDY_BEAR;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__GLOW_WORM] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__GLOW_WORM.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__GLOW_WORM)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__GLOW_WORM)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__GLOW_WORM.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__GLOW_WORM.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__GLOW_WORM;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__ROBOT] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__ROBOT.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__ROBOT)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__ROBOT)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__ROBOT.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__ROBOT.");>>>>>rm2>>>>>*/
        ...
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__BATTLEBOT] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__BATTLEBOT.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__BATTLEBOT)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__BATTLEBOT)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__BATTLEBOT.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__BATTLEBOT.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__BATTLEBOT;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__WALL_E] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__WALL_E.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__WALL_E)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__WALL_E)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__WALL_E.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__WALL_E.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__WALL_E;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__IMPACT_DRILL] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__IMPACT_DRILL.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__IMPACT_DRILL)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__IMPACT_DRILL)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__IMPACT_DRILL.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__IMPACT_DRILL.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__IMPACT_DRILL;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        
        // T7__DH1__BUILD.History behavior
        // uml: [this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__CIRCULAR_SAW] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__CIRCULAR_SAW.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH1__CIRCULAR_SAW)
        if (this.vars.T7__DH1__BUILD_history == T7__DH1__BUILD_HistoryId.T7__DH1__CIRCULAR_SAW)
        {
            // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__CIRCULAR_SAW.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__CIRCULAR_SAW.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH1__CIRCULAR_SAW;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH1__BUILD.History
        ...
        // uml: else / { trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TOY."); } TransitionTo(T7__DH1__TOY)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DH1__BUILD.History to T7__DH1__TOY.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__TOOL_exit;
    this.current_event_handlers[(int)EventId.EV2] = T7__DH1__TOOL_ev2;
    
    // T7__DH1__TOOL behavior
    // uml: enter / { trace("Enter T7__DH1__TOOL."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__TOOL.");`
        //>>>>>ECHO:trace("Enter T7__DH1__TOOL.");
    } // end of behavior for T7__DH1__TOOL
    
    // T7__DH1__TOOL behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TOOL: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TOOL; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TOOL; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TOOL: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TOOL; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__TOOL_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TOOL: check behavior `EV2 TransitionTo(T7__DH1__TOY)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH1__BUILD_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__TOOL to T7__DH1__TOY.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__TOOL to T7__DH1__TOY.");
...
private void T7__DH1__TOOL_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH1__TOOL.InitialState to T7__DH1__IMPACT_DRILL."); } TransitionTo(T7__DH1__IMPACT_DRILL)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__TOOL.InitialState to T7__DH1__IMPACT_DRILL.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__CIRCULAR_SAW_exit;
    ...
    // uml: enter / { trace("Enter T7__DH1__CIRCULAR_SAW."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__CIRCULAR_SAW.");
    } // end of behavior for T7__DH1__CIRCULAR_SAW
    
    // T7__DH1__CIRCULAR_SAW behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__CIRCULAR_SAW: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__CIRCULAR_SAW; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__CIRCULAR_SAW; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__CIRCULAR_SAW: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__CIRCULAR_SAW; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__CIRCULAR_SAW_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__CIRCULAR_SAW."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__CIRCULAR_SAW.");
    } // end of behavior for T7__DH1__CIRCULAR_SAW
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__IMPACT_DRILL_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__IMPACT_DRILL_ev1;
    ...
    // uml: enter / { trace("Enter T7__DH1__IMPACT_DRILL."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__IMPACT_DRILL.");
    } // end of behavior for T7__DH1__IMPACT_DRILL
    
    // T7__DH1__IMPACT_DRILL behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__IMPACT_DRILL: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__IMPACT_DRILL; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__IMPACT_DRILL; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__IMPACT_DRILL: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__IMPACT_DRILL; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__IMPACT_DRILL_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__IMPACT_DRILL."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__IMPACT_DRILL.");
    } // end of behavior for T7__DH1__IMPACT_DRILL
...
private void T7__DH1__IMPACT_DRILL_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__IMPACT_DRILL: check behavior `EV1 TransitionTo(T7__DH1__CIRCULAR_SAW)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__IMPACT_DRILL to T7__DH1__CIRCULAR_SAW.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__TOY_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__TOY_ev1;
    
    // T7__DH1__TOY behavior
    // uml: enter / { trace("Enter T7__DH1__TOY."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__TOY.");`
        //>>>>>ECHO:trace("Enter T7__DH1__TOY.");
    } // end of behavior for T7__DH1__TOY
    
    // T7__DH1__TOY behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TOY: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TOY; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TOY; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TOY: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TOY; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__TOY_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TOY: check behavior `EV1 TransitionTo(T7__DH1__TOOL)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__BUILD` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH1__BUILD_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__TOY to T7__DH1__TOOL.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__TOY to T7__DH1__TOOL.");
...
private void T7__DH1__TOY_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH1__TOY.InitialState to T7__DH1__RACE_CAR."); } TransitionTo(T7__DH1__RACE_CAR)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__TOY.InitialState to T7__DH1__RACE_CAR.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__GLOW_WORM_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__GLOW_WORM_ev1;
    
    // T7__DH1__GLOW_WORM behavior
    // uml: enter / { trace("Enter T7__DH1__GLOW_WORM."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__GLOW_WORM.");`
        //>>>>>ECHO:trace("Enter T7__DH1__GLOW_WORM.");
    } // end of behavior for T7__DH1__GLOW_WORM
    
    // T7__DH1__GLOW_WORM behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__GLOW_WORM: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__GLOW_WORM; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__GLOW_WORM; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__GLOW_WORM: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__GLOW_WORM; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__GLOW_WORM_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__GLOW_WORM."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__GLOW_WORM.");
    } // end of behavior for T7__DH1__GLOW_WORM
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = T7__DH1__TOY_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__TOY_ev1;  // the next ancestor that handles this event is T7__DH1__TOY
}

private void T7__DH1__GLOW_WORM_ev1()
{
    // Setup handler for next ancestor that listens to `EV1` event.
    this.ancestor_event_handler = T7__DH1__TOY_ev1;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__GLOW_WORM: check behavior `EV1 TransitionTo(T7__DH1__ROBOT)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__GLOW_WORM to T7__DH1__ROBOT.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__RACE_CAR_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__RACE_CAR_ev1;
    
    // T7__DH1__RACE_CAR behavior
    // uml: enter / { trace("Enter T7__DH1__RACE_CAR."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__RACE_CAR.");`
        //>>>>>ECHO:trace("Enter T7__DH1__RACE_CAR.");
    } // end of behavior for T7__DH1__RACE_CAR
    
    // T7__DH1__RACE_CAR behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__RACE_CAR: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__RACE_CAR; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__RACE_CAR; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__RACE_CAR: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__RACE_CAR; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__RACE_CAR_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__RACE_CAR."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__RACE_CAR.");
    } // end of behavior for T7__DH1__RACE_CAR
...
private void T7__DH1__RACE_CAR_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__RACE_CAR: check behavior `EV1 TransitionTo(T7__DH1__TEDDY_BEAR)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__TOY` state (Least Common Ancestor for transition).
        T7__DH1__RACE_CAR_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__RACE_CAR to T7__DH1__TEDDY_BEAR.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__RACE_CAR to T7__DH1__TEDDY_BEAR.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__ROBOT_exit;
    
    // T7__DH1__ROBOT behavior
    // uml: enter / { trace("Enter T7__DH1__ROBOT."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__ROBOT.");`
        //>>>>>ECHO:trace("Enter T7__DH1__ROBOT.");
    } // end of behavior for T7__DH1__ROBOT
    
    // T7__DH1__ROBOT behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__ROBOT: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__ROBOT; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__ROBOT; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__ROBOT: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__ROBOT; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__ROBOT_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__ROBOT."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__ROBOT.");
    } // end of behavior for T7__DH1__ROBOT
...
private void T7__DH1__ROBOT_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH1__ROBOT.InitialState to T7__DH1__BATTLEBOT."); } TransitionTo(T7__DH1__BATTLEBOT)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__ROBOT.InitialState to T7__DH1__BATTLEBOT.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__BATTLEBOT_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__BATTLEBOT_ev1;
    
    // T7__DH1__BATTLEBOT behavior
    // uml: enter / { trace("Enter T7__DH1__BATTLEBOT."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__BATTLEBOT.");`
        //>>>>>ECHO:trace("Enter T7__DH1__BATTLEBOT.");
    } // end of behavior for T7__DH1__BATTLEBOT
    
    // T7__DH1__BATTLEBOT behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BATTLEBOT: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__BATTLEBOT; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__BATTLEBOT; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BATTLEBOT: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__BATTLEBOT; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__BATTLEBOT_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__BATTLEBOT."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__BATTLEBOT.");
    } // end of behavior for T7__DH1__BATTLEBOT
...
private void T7__DH1__BATTLEBOT_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__BATTLEBOT: check behavior `EV1 TransitionTo(T7__DH1__WALL_E)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__BATTLEBOT to T7__DH1__WALL_E.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__WALL_E_exit;
    
    // T7__DH1__WALL_E behavior
    // uml: enter / { trace("Enter T7__DH1__WALL_E."); }
    {
        // Step 1: execute action `trace("Enter T7__DH1__WALL_E.");`
        //>>>>>ECHO:trace("Enter T7__DH1__WALL_E.");
    } // end of behavior for T7__DH1__WALL_E
    
    // T7__DH1__WALL_E behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__WALL_E: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__WALL_E; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__WALL_E; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__WALL_E: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__WALL_E; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__WALL_E_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__WALL_E."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__WALL_E.");
    } // end of behavior for T7__DH1__WALL_E
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH1__TEDDY_BEAR_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__DH1__TEDDY_BEAR_ev1;
    ...
    // uml: enter / { trace("Enter T7__DH1__TEDDY_BEAR."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__DH1__TEDDY_BEAR.");
    } // end of behavior for T7__DH1__TEDDY_BEAR
    
    // T7__DH1__TEDDY_BEAR behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TEDDY_BEAR: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TEDDY_BEAR; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TEDDY_BEAR; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TEDDY_BEAR: check behavior `enter / { this.vars.T7__DH1__BUILD_history = T7__DH1__BUILD_HistoryId.T7__DH1__TEDDY_BEAR; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH1__TEDDY_BEAR_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH1__TEDDY_BEAR."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH1__TEDDY_BEAR.");
    } // end of behavior for T7__DH1__TEDDY_BEAR
...
private void T7__DH1__TEDDY_BEAR_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH1__TEDDY_BEAR: check behavior `EV1 TransitionTo(T7__DH1__GLOW_WORM)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH1__TOY` state (Least Common Ancestor for transition).
        T7__DH1__TEDDY_BEAR_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH1__TEDDY_BEAR to T7__DH1__GLOW_WORM.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH1__TEDDY_BEAR to T7__DH1__GLOW_WORM.");
...
private void T7__DEEP_HISTORY2_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DEEP_HISTORY2."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DEEP_HISTORY2.");
    } // end of behavior for T7__DEEP_HISTORY2
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH2__STATE_0_exit;
    this.current_event_handlers[(int)EventId.EVOPEN] = T7__DH2__STATE_0_evopen;
    
    // T7__DH2__state_0 behavior
    // uml: enter / { trace("Enter T7__DH2__state_0."); }
    {
        // Step 1: execute action `trace("Enter T7__DH2__state_0.");`
        //>>>>>ECHO:trace("Enter T7__DH2__state_0.");
...
private void T7__DH2__STATE_0_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH2__state_0."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH2__state_0.");
    } // end of behavior for T7__DH2__state_0
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = T7__DEEP_HISTORY2_exit;
    this.current_event_handlers[(int)EventId.EVOPEN] = null;  // no ancestor listens to this event
}
...
private void T7__DH2__STATE_0_evopen()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_0: check behavior `evOpen TransitionTo(T7__DH2__state_3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DEEP_HISTORY2` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DEEP_HISTORY2_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH2__state_0 to T7__DH2__state_3.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_0 to T7__DH2__state_3.");
        
        // Step 3: Enter/move towards transition target `T7__DH2__state_3`.
        T7__DH2__STATE_3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH2__STATE_3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH2__state_0
}
...
private void T7__DH2__state_0_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH2__state_0.InitialState to T7__DH2__state_0.History."); } TransitionTo(T7__DH2__state_0.History)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_0.InitialState to T7__DH2__state_0.History.");
        ...
        // uml: [this.vars.T7__DH2__state_0_history == T7__DH2__state_0_HistoryId.T7__DH2__state_2] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_2.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH2__state_2)
        if (this.vars.T7__DH2__state_0_history == T7__DH2__state_0_HistoryId.T7__DH2__state_2)
        {
            // Step 1: Exit states until we reach `T7__DH2__state_0` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_2.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_2.");>>>>>rm2>>>>>*/
        ...
        // T7__DH2__state_0.History behavior
        // uml: [this.vars.T7__DH2__state_0_history == T7__DH2__state_0_HistoryId.T7__DH2__state_6] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_6.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH2__state_6)
        if (this.vars.T7__DH2__state_0_history == T7__DH2__state_0_HistoryId.T7__DH2__state_6)
        {
            // Step 1: Exit states until we reach `T7__DH2__state_0` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_6.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_6.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH2__STATE_6;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH2__state_0.History
        
        // T7__DH2__state_0.History behavior
        // uml: [this.vars.T7__DH2__state_0_history == T7__DH2__state_0_HistoryId.T7__DH2__state_9] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_9.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH2__state_9)
        if (this.vars.T7__DH2__state_0_history == T7__DH2__state_0_HistoryId.T7__DH2__state_9)
        {
            // Step 1: Exit states until we reach `T7__DH2__state_0` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_9.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_9.");>>>>>rm2>>>>>*/
            ...
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH2__STATE_9;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH2__state_0.History
        ...
        // uml: else / { trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_1."); } TransitionTo(T7__DH2__state_1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_0.History to T7__DH2__state_1.");
            
            // Step 3: Enter/move towards transition target `T7__DH2__state_1`.
            T7__DH2__STATE_1_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH2__STATE_1;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH2__state_0.History
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH2__STATE_1_exit;
    this.current_event_handlers[(int)EventId.EVSTEP] = T7__DH2__STATE_1_evstep;
    
    // T7__DH2__state_1 behavior
    // uml: enter / { trace("Enter T7__DH2__state_1."); }
    {
        // Step 1: execute action `trace("Enter T7__DH2__state_1.");`
        //>>>>>ECHO:trace("Enter T7__DH2__state_1.");
    } // end of behavior for T7__DH2__state_1
    
    // T7__DH2__state_1 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_1: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_1; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_1: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH2__STATE_1_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH2__state_1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH2__state_1.");
    } // end of behavior for T7__DH2__state_1
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = T7__DH2__STATE_0_exit;
    this.current_event_handlers[(int)EventId.EVSTEP] = null;  // no ancestor listens to this event
}
...
private void T7__DH2__STATE_1_evstep()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_1: check behavior `evStep TransitionTo(T7__DH2__state_2)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_1 to T7__DH2__state_2.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH2__STATE_2_exit;
    this.current_event_handlers[(int)EventId.EVBACK] = T7__DH2__STATE_2_evback;
    
    // T7__DH2__state_2 behavior
    // uml: enter / { trace("Enter T7__DH2__state_2."); }
    {
        // Step 1: execute action `trace("Enter T7__DH2__state_2.");`
        //>>>>>ECHO:trace("Enter T7__DH2__state_2.");
    } // end of behavior for T7__DH2__state_2
    
    // T7__DH2__state_2 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_2: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_2; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_2: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH2__STATE_2_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH2__state_2."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH2__state_2.");
    } // end of behavior for T7__DH2__state_2
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = T7__DH2__STATE_0_exit;
    this.current_event_handlers[(int)EventId.EVBACK] = null;  // no ancestor listens to this event
}
...
private void T7__DH2__STATE_2_evback()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_2: check behavior `evBack TransitionTo(T7__DH2__state_1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH2__state_0` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH2__STATE_0_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH2__state_2 to T7__DH2__state_1.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_2 to T7__DH2__state_1.");
...
private void T7__DH2__state_2_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH2__state_2.InitialState to T7__DH2__state_6."); } TransitionTo(T7__DH2__state_6)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_2.InitialState to T7__DH2__state_6.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH2__STATE_6_exit;
    this.current_event_handlers[(int)EventId.EVSTEP] = T7__DH2__STATE_6_evstep;
    
    // T7__DH2__state_6 behavior
    // uml: enter / { trace("Enter T7__DH2__state_6."); }
    {
        // Step 1: execute action `trace("Enter T7__DH2__state_6.");`
        //>>>>>ECHO:trace("Enter T7__DH2__state_6.");
    } // end of behavior for T7__DH2__state_6
    
    // T7__DH2__state_6 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_6: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_6; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_6; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_6: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_6; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH2__STATE_6_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH2__state_6."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH2__state_6.");
    } // end of behavior for T7__DH2__state_6
...
private void T7__DH2__STATE_6_evstep()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_6: check behavior `evStep TransitionTo(T7__DH2__state_9)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_6 to T7__DH2__state_9.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH2__STATE_9_exit;
    
    // T7__DH2__state_9 behavior
    // uml: enter / { trace("Enter T7__DH2__state_9."); }
    {
        // Step 1: execute action `trace("Enter T7__DH2__state_9.");`
        //>>>>>ECHO:trace("Enter T7__DH2__state_9.");
    } // end of behavior for T7__DH2__state_9
    
    // T7__DH2__state_9 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_9: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_9; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_9; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_9: check behavior `enter / { this.vars.T7__DH2__state_0_history = T7__DH2__state_0_HistoryId.T7__DH2__state_9; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH2__STATE_9_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH2__state_9."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH2__state_9.");
    } // end of behavior for T7__DH2__state_9
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH2__STATE_3_exit;
    this.current_event_handlers[(int)EventId.EVCLOSE] = T7__DH2__STATE_3_evclose;
    
    // T7__DH2__state_3 behavior
    // uml: enter / { trace("Enter T7__DH2__state_3."); }
    {
        // Step 1: execute action `trace("Enter T7__DH2__state_3.");`
        //>>>>>ECHO:trace("Enter T7__DH2__state_3.");
...
private void T7__DH2__STATE_3_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH2__state_3."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH2__state_3.");
    } // end of behavior for T7__DH2__state_3
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = T7__DEEP_HISTORY2_exit;
    this.current_event_handlers[(int)EventId.EVCLOSE] = null;  // no ancestor listens to this event
}
...
private void T7__DH2__STATE_3_evclose()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH2__state_3: check behavior `evClose TransitionTo(T7__DH2__state_0)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DEEP_HISTORY2` state (Least Common Ancestor for transition).
        T7__DH2__STATE_3_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH2__state_3 to T7__DH2__state_0.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH2__state_3 to T7__DH2__state_0.");
...
private void T7__DEEP_HISTORY3_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DEEP_HISTORY3."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DEEP_HISTORY3.");
    } // end of behavior for T7__DEEP_HISTORY3
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH3__STATE_0_exit;
    this.current_event_handlers[(int)EventId.EVOPEN] = T7__DH3__STATE_0_evopen;
    
    // T7__DH3__state_0 behavior
    // uml: enter / { trace("Enter T7__DH3__state_0."); }
    {
        // Step 1: execute action `trace("Enter T7__DH3__state_0.");`
        //>>>>>ECHO:trace("Enter T7__DH3__state_0.");
...
private void T7__DH3__STATE_0_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH3__state_0."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH3__state_0.");
    } // end of behavior for T7__DH3__state_0
...
private void T7__DH3__STATE_0_evopen()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_0: check behavior `evOpen TransitionTo(T7__DH3__state_3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DEEP_HISTORY3` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DEEP_HISTORY3_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH3__state_0 to T7__DH3__state_3.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_0 to T7__DH3__state_3.");
        
        // Step 3: Enter/move towards transition target `T7__DH3__state_3`.
        T7__DH3__STATE_3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH3__STATE_3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH3__state_0
}
...
private void T7__DH3__state_0_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH3__state_0.InitialState to T7__DH3__state_0.History."); } TransitionTo(T7__DH3__state_0.History)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_0.InitialState to T7__DH3__state_0.History.");
        ...
        // uml: [this.vars.T7__DH3__state_0_history == T7__DH3__state_0_HistoryId.T7__DH3__state_2] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH3__state_0.History to T7__DH3__state_2.");>>>>>rm2>>>>>*/ } TransitionTo(T7__DH3__state_2)
        if (this.vars.T7__DH3__state_0_history == T7__DH3__state_0_HistoryId.T7__DH3__state_2)
        {
            // Step 1: Exit states until we reach `T7__DH3__state_0` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__DH3__state_0.History to T7__DH3__state_2.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__DH3__state_0.History to T7__DH3__state_2.");>>>>>rm2>>>>>*/
        ...
        // uml: else / { trace("Transition action `` for T7__DH3__state_0.History to T7__DH3__state_1."); } TransitionTo(T7__DH3__state_1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_0.History to T7__DH3__state_1.");
            
            // Step 3: Enter/move towards transition target `T7__DH3__state_1`.
            T7__DH3__STATE_1_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__DH3__STATE_1;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__DH3__state_0.History
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH3__STATE_1_exit;
    this.current_event_handlers[(int)EventId.EVSTEP] = T7__DH3__STATE_1_evstep;
    
    // T7__DH3__state_1 behavior
    // uml: enter / { trace("Enter T7__DH3__state_1."); }
    {
        // Step 1: execute action `trace("Enter T7__DH3__state_1.");`
        //>>>>>ECHO:trace("Enter T7__DH3__state_1.");
    } // end of behavior for T7__DH3__state_1
    
    // T7__DH3__state_1 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_1: check behavior `enter / { this.vars.T7__DH3__state_0_history = T7__DH3__state_0_HistoryId.T7__DH3__state_1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH3__state_0_history = T7__DH3__state_0_HistoryId.T7__DH3__state_1; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_1: check behavior `enter / { this.vars.T7__DH3__state_0_history = T7__DH3__state_0_HistoryId.T7__DH3__state_1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH3__STATE_1_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH3__state_1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH3__state_1.");
    } // end of behavior for T7__DH3__state_1
...
private void T7__DH3__STATE_1_evstep()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_1: check behavior `evStep TransitionTo(T7__DH3__state_2)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_1 to T7__DH3__state_2.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH3__STATE_2_exit;
    this.current_event_handlers[(int)EventId.EVBACK] = T7__DH3__STATE_2_evback;
    
    // T7__DH3__state_2 behavior
    // uml: enter / { trace("Enter T7__DH3__state_2."); }
    {
        // Step 1: execute action `trace("Enter T7__DH3__state_2.");`
        //>>>>>ECHO:trace("Enter T7__DH3__state_2.");
    } // end of behavior for T7__DH3__state_2
    
    // T7__DH3__state_2 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_2: check behavior `enter / { this.vars.T7__DH3__state_0_history = T7__DH3__state_0_HistoryId.T7__DH3__state_2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__DH3__state_0_history = T7__DH3__state_0_HistoryId.T7__DH3__state_2; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_2: check behavior `enter / { this.vars.T7__DH3__state_0_history = T7__DH3__state_0_HistoryId.T7__DH3__state_2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__DH3__STATE_2_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH3__state_2."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH3__state_2.");
    } // end of behavior for T7__DH3__state_2
...
private void T7__DH3__STATE_2_evback()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_2: check behavior `evBack TransitionTo(T7__DH3__state_1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DH3__state_0` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__DH3__STATE_0_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH3__state_2 to T7__DH3__state_1.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_2 to T7__DH3__state_1.");
...
private void T7__DH3__state_2_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__DH3__state_2.InitialState to T7__DH3__state_6."); } TransitionTo(T7__DH3__state_6)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_2.InitialState to T7__DH3__state_6.");
        
        // Step 3: Enter/move towards transition target `T7__DH3__state_6`.
        T7__DH3__STATE_6_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH3__STATE_6;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH3__STATE_6_exit;
    this.current_event_handlers[(int)EventId.EVSTEP] = T7__DH3__STATE_6_evstep;
    
    // T7__DH3__state_6 behavior
    // uml: enter / { trace("Enter T7__DH3__state_6."); }
    {
        // Step 1: execute action `trace("Enter T7__DH3__state_6.");`
        //>>>>>ECHO:trace("Enter T7__DH3__state_6.");
...
private void T7__DH3__STATE_6_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH3__state_6."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH3__state_6.");
    } // end of behavior for T7__DH3__state_6
...
private void T7__DH3__STATE_6_evstep()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_6: check behavior `evStep TransitionTo(T7__DH3__state_9)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_6 to T7__DH3__state_9.");
        
        // Step 3: Enter/move towards transition target `T7__DH3__state_9`.
        T7__DH3__STATE_9_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__DH3__STATE_9;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__DH3__state_6
}
...
private void T7__DH3__STATE_9_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH3__state_9."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH3__state_9.");
    } // end of behavior for T7__DH3__state_9
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__DH3__STATE_3_exit;
    this.current_event_handlers[(int)EventId.EVCLOSE] = T7__DH3__STATE_3_evclose;
    
    // T7__DH3__state_3 behavior
    // uml: enter / { trace("Enter T7__DH3__state_3."); }
    {
        // Step 1: execute action `trace("Enter T7__DH3__state_3.");`
        //>>>>>ECHO:trace("Enter T7__DH3__state_3.");
...
private void T7__DH3__STATE_3_exit()
{
    ...
    // uml: exit / { trace("Exit T7__DH3__state_3."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__DH3__state_3.");
    } // end of behavior for T7__DH3__state_3
...
private void T7__DH3__STATE_3_evclose()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__DH3__state_3: check behavior `evClose TransitionTo(T7__DH3__state_0)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__DEEP_HISTORY3` state (Least Common Ancestor for transition).
        T7__DH3__STATE_3_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__DH3__state_3 to T7__DH3__state_0.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__DH3__state_3 to T7__DH3__state_0.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__OFF_exit;
    this.current_event_handlers[(int)EventId.EV3] = T7__H1__OFF_ev3;
    this.current_event_handlers[(int)EventId.EV4] = T7__H1__OFF_ev4;
    this.current_event_handlers[(int)EventId.EV7] = T7__H1__OFF_ev7;
    
    // T7__H1__OFF behavior
    // uml: enter / { trace("Enter T7__H1__OFF."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__OFF.");`
        //>>>>>ECHO:trace("Enter T7__H1__OFF.");
...
private void T7__H1__OFF_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF: check behavior `EV3 TransitionTo(T7__H1__OFF3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__H1__OFF` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__H1__OFF_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__OFF to T7__H1__OFF3.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF to T7__H1__OFF3.");
        
        // Step 3: Enter/move towards transition target `T7__H1__OFF3`.
        T7__H1__OFF3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__H1__OFF3;
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
        return;
    } // end of behavior for T7__H1__OFF
}
...
private void T7__H1__OFF_ev4()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF: check behavior `EV4 TransitionTo(T7__H1__OFF)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__HISTORY1` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__HISTORY1_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__OFF to T7__H1__OFF.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF to T7__H1__OFF.");
...
private void T7__H1__OFF_ev7()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF: check behavior `EV7 TransitionTo(T7__H1__ON)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__HISTORY1` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__HISTORY1_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__OFF to T7__H1__ON.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF to T7__H1__ON.");
...
private void T7__H1__OFF_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__H1__OFF.InitialState to T7__H1__OFF.History."); } TransitionTo(T7__H1__OFF.History)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF.InitialState to T7__H1__OFF.History.");
        ...
        // uml: [this.vars.T7__H1__OFF_history == T7__H1__OFF_HistoryId.T7__H1__OFF2] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF2.");>>>>>rm2>>>>>*/ } TransitionTo(T7__H1__OFF2)
        if (this.vars.T7__H1__OFF_history == T7__H1__OFF_HistoryId.T7__H1__OFF2)
        {
            // Step 1: Exit states until we reach `T7__H1__OFF` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF2.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF2.");>>>>>rm2>>>>>*/
            
            // Step 3: Enter/move towards transition target `T7__H1__OFF2`.
            T7__H1__OFF2_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__H1__OFF2;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__H1__OFF.History
        
        // T7__H1__OFF.History behavior
        // uml: [this.vars.T7__H1__OFF_history == T7__H1__OFF_HistoryId.T7__H1__OFF3] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF3.");>>>>>rm2>>>>>*/ } TransitionTo(T7__H1__OFF3)
        if (this.vars.T7__H1__OFF_history == T7__H1__OFF_HistoryId.T7__H1__OFF3)
        {
            // Step 1: Exit states until we reach `T7__H1__OFF` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF3.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF3.");>>>>>rm2>>>>>*/
        ...
        // uml: else / { trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF1."); } TransitionTo(T7__H1__OFF1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF.History to T7__H1__OFF1.");
            
            // Step 3: Enter/move towards transition target `T7__H1__OFF1`.
            T7__H1__OFF1_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__H1__OFF1;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__H1__OFF.History
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__OFF1_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__H1__OFF1_ev1;
    
    // T7__H1__OFF1 behavior
    // uml: enter / { trace("Enter T7__H1__OFF1."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__OFF1.");`
        //>>>>>ECHO:trace("Enter T7__H1__OFF1.");
    } // end of behavior for T7__H1__OFF1
    
    // T7__H1__OFF1 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF1: check behavior `enter / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF1; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF1: check behavior `enter / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__H1__OFF1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF1: check behavior `EV1 TransitionTo(T7__H1__OFF2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__H1__OFF` state (Least Common Ancestor for transition).
        T7__H1__OFF1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__OFF1 to T7__H1__OFF2.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF1 to T7__H1__OFF2.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__OFF2_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__H1__OFF2_ev1;
    
    // T7__H1__OFF2 behavior
    // uml: enter / { trace("Enter T7__H1__OFF2."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__OFF2.");`
        //>>>>>ECHO:trace("Enter T7__H1__OFF2.");
    } // end of behavior for T7__H1__OFF2
    
    // T7__H1__OFF2 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF2: check behavior `enter / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF2; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF2: check behavior `enter / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__H1__OFF2_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF2: check behavior `EV1 TransitionTo(T7__H1__OFF3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__H1__OFF` state (Least Common Ancestor for transition).
        T7__H1__OFF2_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__OFF2 to T7__H1__OFF3.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__OFF2 to T7__H1__OFF3.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__OFF3_exit;
    
    // T7__H1__OFF3 behavior
    // uml: enter / { trace("Enter T7__H1__OFF3."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__OFF3.");`
        //>>>>>ECHO:trace("Enter T7__H1__OFF3.");
    } // end of behavior for T7__H1__OFF3
    
    // T7__H1__OFF3 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF3: check behavior `enter / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF3; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF3; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__H1__OFF3: check behavior `enter / { this.vars.T7__H1__OFF_history = T7__H1__OFF_HistoryId.T7__H1__OFF3; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__ON_exit;
    this.current_event_handlers[(int)EventId.EV6] = T7__H1__ON_ev6;
    
    // T7__H1__ON behavior
    // uml: enter / { trace("Enter T7__H1__ON."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__ON.");`
        //>>>>>ECHO:trace("Enter T7__H1__ON.");
...
private void T7__H1__ON_ev6()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON: check behavior `EV6 TransitionTo(T7__H1__OFF)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__HISTORY1` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__HISTORY1_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__ON to T7__H1__OFF.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__ON to T7__H1__OFF.");
...
private void T7__H1__ON_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__H1__ON.InitialState to T7__H1__ON.History."); } TransitionTo(T7__H1__ON.History)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__H1__ON.InitialState to T7__H1__ON.History.");
        ...
        // uml: [this.vars.T7__H1__ON_history == T7__H1__ON_HistoryId.T7__H1__ON2] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__ON.History to T7__H1__ON2.");>>>>>rm2>>>>>*/ } TransitionTo(T7__H1__ON2)
        if (this.vars.T7__H1__ON_history == T7__H1__ON_HistoryId.T7__H1__ON2)
        {
            // Step 1: Exit states until we reach `T7__H1__ON` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__ON.History to T7__H1__ON2.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__ON.History to T7__H1__ON2.");>>>>>rm2>>>>>*/
            
            // Step 3: Enter/move towards transition target `T7__H1__ON2`.
            T7__H1__ON2_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__H1__ON2;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__H1__ON.History
        
        // T7__H1__ON.History behavior
        // uml: [this.vars.T7__H1__ON_history == T7__H1__ON_HistoryId.T7__H1__ON3] / { /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__ON.History to T7__H1__ON3.");>>>>>rm2>>>>>*/ } TransitionTo(T7__H1__ON3)
        if (this.vars.T7__H1__ON_history == T7__H1__ON_HistoryId.T7__H1__ON3)
        {
            // Step 1: Exit states until we reach `T7__H1__ON` state (Least Common Ancestor for transition). Already at LCA, no exiting required.
            
            // Step 2: Transition action: `/*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__ON.History to T7__H1__ON3.");>>>>>rm2>>>>>*/`.
            /*<<<<<rm2<<<<<trace("Transition action `` for T7__H1__ON.History to T7__H1__ON3.");>>>>>rm2>>>>>*/
            
            // Step 3: Enter/move towards transition target `T7__H1__ON3`.
            T7__H1__ON3_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__H1__ON3;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__H1__ON.History
        ...
        // uml: else / { trace("Transition action `` for T7__H1__ON.History to T7__H1__ON1."); } TransitionTo(T7__H1__ON1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__H1__ON.History to T7__H1__ON1.");
            
            // Step 3: Enter/move towards transition target `T7__H1__ON1`.
            T7__H1__ON1_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.T7__H1__ON1;
            this.ancestor_event_handler = null;
            return;
        } // end of behavior for T7__H1__ON.History
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__ON1_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__H1__ON1_ev1;
    
    // T7__H1__ON1 behavior
    // uml: enter / { trace("Enter T7__H1__ON1."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__ON1.");`
        //>>>>>ECHO:trace("Enter T7__H1__ON1.");
    } // end of behavior for T7__H1__ON1
    
    // T7__H1__ON1 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON1: check behavior `enter / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON1; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON1: check behavior `enter / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON1; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__H1__ON1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON1: check behavior `EV1 TransitionTo(T7__H1__ON2)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__H1__ON1 to T7__H1__ON2.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__ON2_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__H1__ON2_ev1;
    
    // T7__H1__ON2 behavior
    // uml: enter / { trace("Enter T7__H1__ON2."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__ON2.");`
        //>>>>>ECHO:trace("Enter T7__H1__ON2.");
    } // end of behavior for T7__H1__ON2
    
    // T7__H1__ON2 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON2: check behavior `enter / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON2; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON2: check behavior `enter / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON2; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__H1__ON2_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON2: check behavior `EV1 TransitionTo(T7__H1__ON3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__H1__ON` state (Least Common Ancestor for transition).
        T7__H1__ON2_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__ON2 to T7__H1__ON3.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__ON2 to T7__H1__ON3.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__H1__ON3_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__H1__ON3_ev1;
    
    // T7__H1__ON3 behavior
    // uml: enter / { trace("Enter T7__H1__ON3."); }
    {
        // Step 1: execute action `trace("Enter T7__H1__ON3.");`
        //>>>>>ECHO:trace("Enter T7__H1__ON3.");
    } // end of behavior for T7__H1__ON3
    
    // T7__H1__ON3 behavior
    // uml: enter [/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON3: check behavior `enter / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON3; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/] / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON3; }
    if (/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON3: check behavior `enter / { this.vars.T7__H1__ON_history = T7__H1__ON_HistoryId.T7__H1__ON3; }`.", >>>>>rm2>>>>>*/true/*<<<<<rm2<<<<<)>>>>>rm2>>>>>*/)
    {
...
private void T7__H1__ON3_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__H1__ON3: check behavior `EV1 TransitionTo(T7__H1__ON1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__H1__ON` state (Least Common Ancestor for transition).
        T7__H1__ON3_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__H1__ON3 to T7__H1__ON1.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__H1__ON3 to T7__H1__ON1.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__INITIAL1__PARENT_exit;
    this.current_event_handlers[(int)EventId.EV5] = T7__INITIAL1__PARENT_ev5;
    ...
    // uml: enter / { trace("Enter T7__INITIAL1__PARENT."); }
    {
        ...
        //>>>>>ECHO:trace("Enter T7__INITIAL1__PARENT.");
...
private void T7__INITIAL1__PARENT_exit()
{
    ...
    // uml: exit / { trace("Exit T7__INITIAL1__PARENT."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__INITIAL1__PARENT.");
    } // end of behavior for T7__INITIAL1__PARENT
...
private void T7__INITIAL1__PARENT_ev5()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__INITIAL1__PARENT: check behavior `EV5 / { count++; }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count++;`
        //>>>>>ECHO:self->vars.count++;
...
private void T7__INITIAL1__PARENT_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for T7__INITIAL1__PARENT.InitialState to T7__INITIAL1__S1."); } TransitionTo(T7__INITIAL1__S1)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__PARENT.InitialState to T7__INITIAL1__S1.");
        
        // Step 3: Enter/move towards transition target `T7__INITIAL1__S1`.
        T7__INITIAL1__S1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__INITIAL1__S1;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__INITIAL1__G_exit;
    this.current_event_handlers[(int)EventId.EV2] = T7__INITIAL1__G_ev2;
    
    // T7__INITIAL1__G behavior
    // uml: enter / { trace("Enter T7__INITIAL1__G."); }
    {
        // Step 1: execute action `trace("Enter T7__INITIAL1__G.");`
        //>>>>>ECHO:trace("Enter T7__INITIAL1__G.");
...
private void T7__INITIAL1__G_exit()
{
    ...
    // uml: exit / { trace("Exit T7__INITIAL1__G."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__INITIAL1__G.");
    } // end of behavior for T7__INITIAL1__G
...
private void T7__INITIAL1__G_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__INITIAL1__G: check behavior `EV2 TransitionTo(T7__INITIAL1__PARENT.InitialState)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__INITIAL1__PARENT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(T7__INITIAL1__PARENT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for T7__INITIAL1__G to T7__INITIAL1__PARENT.InitialState.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__G to T7__INITIAL1__PARENT.InitialState.");
...
private void T7__INITIAL1__G_InitialState_transition()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__G.InitialState to T7__INITIAL1__G_S1.");
        
        // Step 3: Enter/move towards transition target `T7__INITIAL1__G_S1`.
        T7__INITIAL1__G_S1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__INITIAL1__G_S1;
        this.ancestor_event_handler = null;
        return;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 2>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__G.InitialState to T7__INITIAL1__G_S2.");
        
        // Step 3: Enter/move towards transition target `T7__INITIAL1__G_S2`.
        T7__INITIAL1__G_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__INITIAL1__G_S2;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for T7__INITIAL1__G.InitialState
    ...
    // uml: else / { trace("Transition action `` for T7__INITIAL1__G.InitialState to T7__INITIAL1__G_S3."); } TransitionTo(T7__INITIAL1__G_S3)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__G.InitialState to T7__INITIAL1__G_S3.");
        
        // Step 3: Enter/move towards transition target `T7__INITIAL1__G_S3`.
        T7__INITIAL1__G_S3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.T7__INITIAL1__G_S3;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for T7__INITIAL1__G.InitialState
}
...
private void T7__INITIAL1__G_S1_exit()
{
    ...
    // uml: exit / { trace("Exit T7__INITIAL1__G_S1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__INITIAL1__G_S1.");
    } // end of behavior for T7__INITIAL1__G_S1
...
private void T7__INITIAL1__G_S2_exit()
{
    ...
    // uml: exit / { trace("Exit T7__INITIAL1__G_S2."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__INITIAL1__G_S2.");
    } // end of behavior for T7__INITIAL1__G_S2
...
private void T7__INITIAL1__G_S3_exit()
{
    ...
    // uml: exit / { trace("Exit T7__INITIAL1__G_S3."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__INITIAL1__G_S3.");
    } // end of behavior for T7__INITIAL1__G_S3
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = T7__INITIAL1__S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = T7__INITIAL1__S1_ev1;
    this.current_event_handlers[(int)EventId.EV3] = T7__INITIAL1__S1_ev3;
    
    // T7__INITIAL1__S1 behavior
    // uml: enter / { trace("Enter T7__INITIAL1__S1."); }
    {
        // Step 1: execute action `trace("Enter T7__INITIAL1__S1.");`
        //>>>>>ECHO:trace("Enter T7__INITIAL1__S1.");
...
private void T7__INITIAL1__S1_exit()
{
    ...
    // uml: exit / { trace("Exit T7__INITIAL1__S1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit T7__INITIAL1__S1.");
    } // end of behavior for T7__INITIAL1__S1
...
private void T7__INITIAL1__S1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__INITIAL1__S1: check behavior `EV1 TransitionTo(T7__INITIAL1__G)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__INITIAL1__PARENT` state (Least Common Ancestor for transition).
        T7__INITIAL1__S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__INITIAL1__S1 to T7__INITIAL1__G.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__S1 to T7__INITIAL1__G.");
...
private void T7__INITIAL1__S1_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State T7__INITIAL1__S1: check behavior `EV3 TransitionTo(T7__INITIAL1__G.InitialState)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `T7__INITIAL1__PARENT` state (Least Common Ancestor for transition).
        T7__INITIAL1__S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for T7__INITIAL1__S1 to T7__INITIAL1__G.InitialState.");`.
        //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1__S1 to T7__INITIAL1__G.InitialState.");
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST7_DECIDE_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST7_DECIDE_ev1;
    this.current_event_handlers[(int)EventId.EV2] = TEST7_DECIDE_ev2;
    this.current_event_handlers[(int)EventId.EV3] = TEST7_DECIDE_ev3;
    this.current_event_handlers[(int)EventId.EV4] = TEST7_DECIDE_ev4;
    this.current_event_handlers[(int)EventId.EV5] = TEST7_DECIDE_ev5;
    
    // TEST7_DECIDE behavior
    // uml: enter / { trace("Enter TEST7_DECIDE."); }
    {
        // Step 1: execute action `trace("Enter TEST7_DECIDE.");`
        //>>>>>ECHO:trace("Enter TEST7_DECIDE.");
...
private void TEST7_DECIDE_exit()
{
    ...
    // uml: exit / { trace("Exit TEST7_DECIDE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST7_DECIDE.");
    } // end of behavior for TEST7_DECIDE
    
    // TEST7_DECIDE behavior
    // uml: exit [trace_guard("State TEST7_DECIDE: check behavior `exit / { clear_dispatch_output(); }`.", true)] / { clear_dispatch_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7_DECIDE: check behavior `exit / { clear_dispatch_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_dispatch_output();`
        //>>>>>ECHO:trace("CLEAR_OUTPUT_BEFORE_THIS_AND_FOR_THIS_EVENT_DISPATCH");;
    } // end of behavior for TEST7_DECIDE
...
private void TEST7_DECIDE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7_DECIDE: check behavior `EV1 TransitionTo(T7__INITIAL1)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST7_DECIDE to T7__INITIAL1.");
        ...
        // uml: / { trace("Transition action `` for T7__INITIAL1.InitialState to T7__INITIAL1__PARENT."); } TransitionTo(T7__INITIAL1__PARENT)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__INITIAL1.InitialState to T7__INITIAL1__PARENT.");
...
private void TEST7_DECIDE_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7_DECIDE: check behavior `EV2 TransitionTo(T7__HISTORY1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST7_INITIAL_OR_HISTORY` state (Least Common Ancestor for transition).
        TEST7_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST7_DECIDE to T7__HISTORY1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST7_DECIDE to T7__HISTORY1.");
        ...
        // uml: / { trace("Transition action `` for T7__HISTORY1.InitialState to T7__H1__ON."); } TransitionTo(T7__H1__ON)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__HISTORY1.InitialState to T7__H1__ON.");
...
private void TEST7_DECIDE_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7_DECIDE: check behavior `EV3 TransitionTo(T7__DEEP_HISTORY1)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST7_INITIAL_OR_HISTORY` state (Least Common Ancestor for transition).
        TEST7_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST7_DECIDE to T7__DEEP_HISTORY1.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST7_DECIDE to T7__DEEP_HISTORY1.");
        ...
        // uml: / { trace("Transition action `` for T7__DEEP_HISTORY1.InitialState to T7__DH1__BUILD."); } TransitionTo(T7__DH1__BUILD)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DEEP_HISTORY1.InitialState to T7__DH1__BUILD.");
...
private void TEST7_DECIDE_ev4()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7_DECIDE: check behavior `EV4 TransitionTo(T7__DEEP_HISTORY2)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST7_INITIAL_OR_HISTORY` state (Least Common Ancestor for transition).
        TEST7_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST7_DECIDE to T7__DEEP_HISTORY2.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST7_DECIDE to T7__DEEP_HISTORY2.");
        ...
        // uml: / { trace("Transition action `` for T7__DEEP_HISTORY2.InitialState to T7__DH2__state_0."); } TransitionTo(T7__DH2__state_0)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DEEP_HISTORY2.InitialState to T7__DH2__state_0.");
...
private void TEST7_DECIDE_ev5()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST7_DECIDE: check behavior `EV5 TransitionTo(T7__DEEP_HISTORY3)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST7_INITIAL_OR_HISTORY` state (Least Common Ancestor for transition).
        TEST7_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST7_DECIDE to T7__DEEP_HISTORY3.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST7_DECIDE to T7__DEEP_HISTORY3.");
        ...
        // uml: / { trace("Transition action `` for T7__DEEP_HISTORY3.InitialState to T7__DH3__state_0."); } TransitionTo(T7__DH3__state_0)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for T7__DEEP_HISTORY3.InitialState to T7__DH3__state_0.");
...
private void TEST8_ENTRY_CHOICE_exit()
{
    ...
    // uml: exit / { trace("Exit TEST8_ENTRY_CHOICE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST8_ENTRY_CHOICE.");
    } // end of behavior for TEST8_ENTRY_CHOICE
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST8_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV3] = TEST8_ROOT_ev3;
    this.current_event_handlers[(int)EventId.EV5] = TEST8_ROOT_ev5;
    
    // TEST8_ROOT behavior
    // uml: enter / { trace("Enter TEST8_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST8_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST8_ROOT.");
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_ROOT: check behavior `enter / { clear_dispatch_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_dispatch_output();`
        //>>>>>ECHO:trace("CLEAR_OUTPUT_BEFORE_THIS_AND_FOR_THIS_EVENT_DISPATCH");;
    } // end of behavior for TEST8_ROOT
...
private void TEST8_ROOT_ev3()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_ROOT: check behavior `EV3`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action ``
        // Step 2: determine if ancestor gets to handle event next.
        // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
...
private void TEST8_ROOT_ev5()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_ROOT: check behavior `EV5 / { count++; }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count++;`
        //>>>>>ECHO:self->vars.count++;
...
private void TEST8_ROOT_EntryPoint_1__transition()
{
    ...
    // uml: / { trace("Transition action `` for TEST8_ROOT.EntryPoint(1) to TEST8_S1."); } TransitionTo(TEST8_S1)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST8_ROOT.EntryPoint(1) to TEST8_S1.");
        
        // Step 3: Enter/move towards transition target `TEST8_S1`.
        TEST8_S1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST8_S1;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST8_G_exit;
    this.current_event_handlers[(int)EventId.EV2] = TEST8_G_ev2;
    
    // TEST8_G behavior
    // uml: enter / { trace("Enter TEST8_G."); }
    {
        // Step 1: execute action `trace("Enter TEST8_G.");`
        //>>>>>ECHO:trace("Enter TEST8_G.");
...
private void TEST8_G_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_G: check behavior `EV2 TransitionTo(TEST8_ROOT.EntryPoint(1))`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST8_ROOT` state (Least Common Ancestor for transition).
        exit_up_to_state_handler(TEST8_ROOT_exit);
        
        // Step 2: Transition action: `trace("Transition action `` for TEST8_G to TEST8_ROOT.EntryPoint(1).");`.
        //>>>>>ECHO:trace("Transition action `` for TEST8_G to TEST8_ROOT.EntryPoint(1).");
...
private void TEST8_G_EntryPoint_1__transition()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST8_G.EntryPoint(1) to TEST8_G_S1.");
        
        // Step 3: Enter/move towards transition target `TEST8_G_S1`.
        TEST8_G_S1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST8_G_S1;
        this.ancestor_event_handler = null;
        return;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 2>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST8_G.EntryPoint(1) to TEST8_G_S2.");
        
        // Step 3: Enter/move towards transition target `TEST8_G_S2`.
        TEST8_G_S2_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST8_G_S2;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST8_G.EntryPoint(1)
    ...
    // uml: else / { trace("Transition action `` for TEST8_G.EntryPoint(1) to TEST8_G_S3."); } TransitionTo(TEST8_G_S3)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST8_G.EntryPoint(1) to TEST8_G_S3.");
        
        // Step 3: Enter/move towards transition target `TEST8_G_S3`.
        TEST8_G_S3_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST8_G_S3;
        this.ancestor_event_handler = null;
        return;
    } // end of behavior for TEST8_G.EntryPoint(1)
}
...
private void TEST8_G_EntryPoint_3__transition()
{
    ...
    // uml: / { trace("Transition action `count += 0;` for TEST8_G.EntryPoint(3) to TEST8_G.EntryPoint(1).");\ncount += 0; } TransitionTo(TEST8_G.EntryPoint(1))
    {
        ...
        //>>>>>ECHO:trace("Transition action `count += 0;` for TEST8_G.EntryPoint(3) to TEST8_G.EntryPoint(1).");
        //>>>>>ECHO:self->vars.count += 0;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST8_S1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST8_S1_ev1;
    this.current_event_handlers[(int)EventId.EV3] = TEST8_S1_ev3;
    this.current_event_handlers[(int)EventId.EV6] = TEST8_S1_ev6;
    
    // TEST8_S1 behavior
    // uml: enter / { trace("Enter TEST8_S1."); }
    {
        // Step 1: execute action `trace("Enter TEST8_S1.");`
        //>>>>>ECHO:trace("Enter TEST8_S1.");
...
private void TEST8_S1_exit()
{
    ...
    // uml: exit / { trace("Exit TEST8_S1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST8_S1.");
    } // end of behavior for TEST8_S1
    
    // adjust function pointers for this state's exit
    this.current_state_exit_handler = TEST8_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV1] = null;  // no ancestor listens to this event
    this.current_event_handlers[(int)EventId.EV3] = TEST8_ROOT_ev3;  // the next ancestor that handles this event is TEST8_ROOT
    this.current_event_handlers[(int)EventId.EV6] = null;  // no ancestor listens to this event
}
...
private void TEST8_S1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_S1: check behavior `1. EV1 TransitionTo(TEST8_G.EntryPoint(1))`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST8_ROOT` state (Least Common Ancestor for transition).
        TEST8_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST8_S1 to TEST8_G.EntryPoint(1).");`.
        //>>>>>ECHO:trace("Transition action `` for TEST8_S1 to TEST8_G.EntryPoint(1).");
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_S1: check behavior `2. EV1 / { count++; /* shouldn't run *>>>>>rm2>>>>>##/ }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count++; /* shouldn't run */`
        //>>>>>ECHO:self->vars.count++; /* shouldn't run */
...
private void TEST8_S1_ev3()
{
    ...
    this.ancestor_event_handler = TEST8_ROOT_ev3;
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_S1: check behavior `EV3 TransitionTo(TEST8_G.EntryPoint(3))`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST8_ROOT` state (Least Common Ancestor for transition).
        TEST8_S1_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST8_S1 to TEST8_G.EntryPoint(3).");`.
        //>>>>>ECHO:trace("Transition action `` for TEST8_S1 to TEST8_G.EntryPoint(3).");
...
private void TEST8_S1_ev6()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST8_S1: check behavior `EV6 TransitionTo(TEST8_G.EntryPoint(3))`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST8_ROOT` state (Least Common Ancestor for transition).
        TEST8_S1_exit();
...
private void TEST9_EXIT_CHOICE_exit()
{
    ...
    // uml: exit / { trace("Exit TEST9_EXIT_CHOICE."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST9_EXIT_CHOICE.");
    } // end of behavior for TEST9_EXIT_CHOICE
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST9_DECIDE_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST9_DECIDE_ev1;
    this.current_event_handlers[(int)EventId.EV2] = TEST9_DECIDE_ev2;
    
    // TEST9_DECIDE behavior
    // uml: enter / { trace("Enter TEST9_DECIDE."); }
    {
        // Step 1: execute action `trace("Enter TEST9_DECIDE.");`
        //>>>>>ECHO:trace("Enter TEST9_DECIDE.");
...
private void TEST9_DECIDE_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9_DECIDE: check behavior `EV1 TransitionTo(TEST9_ROOT)`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST9_DECIDE to TEST9_ROOT.");
        ...
        // uml: / { trace("Transition action `` for TEST9_ROOT.InitialState to TEST9_S1."); } TransitionTo(TEST9_S1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST9_ROOT.InitialState to TEST9_S1.");
            ...
            // uml: / { trace("Transition action `` for TEST9_S1.InitialState to TEST9_S1_1."); } TransitionTo(TEST9_S1_1)
            {
                ...
                //>>>>>ECHO:trace("Transition action `` for TEST9_S1.InitialState to TEST9_S1_1.");
                
                // Step 3: Enter/move towards transition target `TEST9_S1_1`.
                TEST9_S1_1_enter();
                
                // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
                this.state_id = StateId.TEST9_S1_1;
                // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
                return;
...
private void TEST9_DECIDE_ev2()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9_DECIDE: check behavior `EV2 TransitionTo(TEST9A_ROOT)`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: Exit states until we reach `TEST9_EXIT_CHOICE` state (Least Common Ancestor for transition).
        TEST9_DECIDE_exit();
        
        // Step 2: Transition action: `trace("Transition action `` for TEST9_DECIDE to TEST9A_ROOT.");`.
        //>>>>>ECHO:trace("Transition action `` for TEST9_DECIDE to TEST9A_ROOT.");
        ...
        // uml: / { trace("Transition action `count = 0;` for TEST9A_ROOT.InitialState to TEST9A_S1.");\ncount = 0; } TransitionTo(TEST9A_S1)
        {
            ...
            //>>>>>ECHO:trace("Transition action `count = 0;` for TEST9A_ROOT.InitialState to TEST9A_S1.");
            //>>>>>ECHO:self->vars.count = 0;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST9_ROOT_exit;
    this.current_event_handlers[(int)EventId.EV5] = TEST9_ROOT_ev5;
    
    // TEST9_ROOT behavior
    // uml: enter / { trace("Enter TEST9_ROOT."); }
    {
        // Step 1: execute action `trace("Enter TEST9_ROOT.");`
        //>>>>>ECHO:trace("Enter TEST9_ROOT.");
...
private void TEST9_ROOT_ev5()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9_ROOT: check behavior `EV5 / { count++; }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count++;`
        //>>>>>ECHO:self->vars.count++;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST9_S1_1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST9_S1_1_ev1;
    
    // TEST9_S1_1 behavior
    // uml: enter / { trace("Enter TEST9_S1_1."); }
    {
        // Step 1: execute action `trace("Enter TEST9_S1_1.");`
        //>>>>>ECHO:trace("Enter TEST9_S1_1.");
    } // end of behavior for TEST9_S1_1
    
    // TEST9_S1_1 behavior
    // uml: enter [trace_guard("State TEST9_S1_1: check behavior `enter / { clear_output(); }`.", true)] / { clear_output(); }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9_S1_1: check behavior `enter / { clear_output(); }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST9_S1_1
...
private void TEST9_S1_1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9_S1_1: check behavior `EV1 TransitionTo(TEST9_S1.ExitPoint(1))`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST9_S1_1 to TEST9_S1.ExitPoint(1).");
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 4>>>>>rm2>>>>>*/)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST9_S1.ExitPoint(1) to TEST9_G_S4.");
            
            // Step 3: Enter/move towards transition target `TEST9_G_S4`.
            TEST9_G_S4_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST9_G_S4;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 1>>>>>rm2>>>>>*/)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST9_S1.ExitPoint(1) to TEST9_G_S1.");
            
            // Step 3: Enter/move towards transition target `TEST9_G_S1`.
            TEST9_G_S1_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST9_G_S1;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
        } // end of behavior for TEST9_S1.ExitPoint(1)
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<self->vars.count == 2>>>>>rm2>>>>>*/)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST9_S1.ExitPoint(1) to TEST9_G_S2.");
            
            // Step 3: Enter/move towards transition target `TEST9_G_S2`.
            TEST9_G_S2_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST9_G_S2;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
        } // end of behavior for TEST9_S1.ExitPoint(1)
        ...
        // uml: else / { trace("Transition action `` for TEST9_S1.ExitPoint(1) to TEST9_G_S3."); } TransitionTo(TEST9_G_S3)
        {
            ...
            //>>>>>ECHO:trace("Transition action `` for TEST9_S1.ExitPoint(1) to TEST9_G_S3.");
            
            // Step 3: Enter/move towards transition target `TEST9_G_S3`.
            TEST9_G_S3_enter();
            
            // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
            this.state_id = StateId.TEST9_G_S3;
            // No ancestor handles event. Can skip nulling `ancestor_event_handler`.
            return;
        } // end of behavior for TEST9_S1.ExitPoint(1)
    } // end of behavior for TEST9_S1_1
...
private void TEST9A_S1_InitialState_transition()
{
    ...
    // uml: / { trace("Transition action `` for TEST9A_S1.InitialState to TEST9A_S1_1."); } TransitionTo(TEST9A_S1_1)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST9A_S1.InitialState to TEST9A_S1_1.");
        
        // Step 3: Enter/move towards transition target `TEST9A_S1_1`.
        TEST9A_S1_1_enter();
        
        // Step 4: complete transition. Ends event dispatch. No other behaviors are checked.
        this.state_id = StateId.TEST9A_S1_1;
        this.ancestor_event_handler = null;
        return;
...
{
    // setup trigger/event handlers
    this.current_state_exit_handler = TEST9A_S1_1_exit;
    this.current_event_handlers[(int)EventId.EV1] = TEST9A_S1_1_ev1;
    
    // TEST9A_S1_1 behavior
    // uml: enter / { trace("Enter TEST9A_S1_1."); }
    {
        // Step 1: execute action `trace("Enter TEST9A_S1_1.");`
        //>>>>>ECHO:trace("Enter TEST9A_S1_1.");
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9A_S1_1: check behavior `enter [count == 0] / { clear_output(); }`.", self->vars.count == 0)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `clear_output();`
        //>>>>>ECHO:trace("IGNORE_OUTPUT_BEFORE_THIS");;
    } // end of behavior for TEST9A_S1_1
...
private void TEST9A_S1_1_exit()
{
    ...
    // uml: exit / { trace("Exit TEST9A_S1_1."); }
    {
        ...
        //>>>>>ECHO:trace("Exit TEST9A_S1_1.");
    } // end of behavior for TEST9A_S1_1
    
    // TEST9A_S1_1 behavior
    // uml: exit [trace_guard("State TEST9A_S1_1: check behavior `exit / { count = 100; }`.", true)] / { count = 100; }
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9A_S1_1: check behavior `exit / { count = 100; }`.", true)>>>>>rm2>>>>>*/)
    {
        // Step 1: execute action `count = 100;`
        //>>>>>ECHO:self->vars.count = 100;
    } // end of behavior for TEST9A_S1_1
...
private void TEST9A_S1_1_ev1()
{
    ...
    if (383849285762 == 383849285762/*<<<<<rm2<<<<<trace_guard("State TEST9A_S1_1: check behavior `EV1 TransitionTo(TEST9A_S1.ExitPoint(1))`.", true)>>>>>rm2>>>>>*/)
    {
        ...
        //>>>>>ECHO:trace("Transition action `` for TEST9A_S1_1 to TEST9A_S1.ExitPoint(1).");
        ...
        if (383849285762 == 383849285762/*<<<<<rm2<<<<<true>>>>>rm2>>>>>*/)
        {
            // Step 1: Exit states until we reach `TEST9A_S1` state (Least Common Ancestor for transition).
            TEST9A_S1_exit();
            
            // Step 2: Transition action: `trace("Transition action `count++;` for TEST9A_S1.ExitPoint(1) to TEST9A_S1.");\ncount++;`.
            //>>>>>ECHO:trace("Transition action `count++;` for TEST9A_S1.ExitPoint(1) to TEST9A_S1.");
            //>>>>>ECHO:self->vars.count++;
