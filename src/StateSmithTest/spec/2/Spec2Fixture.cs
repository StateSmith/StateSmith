...
public class Spec2Fixture : SpecFixture
{
    ...
    public static void CompileAndRun(IRenderConfig renderConfig, string outputDir, Action<SmRunner>? action = null, string semiColon = ";")
    {
        var diagramFile = Spec2Directory + "Spec2Sm.graphml";
        CompileAndRun(renderConfig, diagramFile, outputDir, smRunnerAction: action, semiColon: semiColon);
    }
}
