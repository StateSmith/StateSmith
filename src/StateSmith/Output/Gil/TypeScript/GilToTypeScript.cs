...
public class GilToTypeScript : IGilTranspiler
{
    ...
    public GilToTypeScript(IOutputInfo outputInfo, RenderConfigJavaVars renderConfigJava, RenderConfigBaseVars renderConfig, ICodeFileWriter codeFileWriter, RoslynCompiler roslynCompiler)
    {
    ...
    public void TranspileAndOutputCode(string gilCode)
    {
        ...
        TypeScriptGilVisitor gilVisitor = new(gilCode, fileSb, renderConfigJava, renderConfig, roslynCompiler);
        gilVisitor.Process();
