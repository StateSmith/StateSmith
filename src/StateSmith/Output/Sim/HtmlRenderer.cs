          ...
          <div class='dropdown'>
            ...
            <div id='myDropdown' class='dropdown-content'>
              ...
              <div class='dropdown-item' style='cursor: default;' >
                ...
                <input type='color' id='savedSetting_stateTitleTextColor' value='#ababab' title='State title text color.'>
                <input type='color' id='savedSetting_stateStrokeColor' value='#999999' title='State stroke color.'>
