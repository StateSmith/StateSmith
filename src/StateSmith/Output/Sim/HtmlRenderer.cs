...
public class HtmlRenderer
{
    public static void Render(StringBuilder stringBuilder, string smName, string mermaidCode, string jsCode, string diagramEventNamesArray, string jsStateEventsMapping, string jsStateEdgeMapping, string jsStateDescriptionMapping)
    {
        ...
        // You can use back tick strings in js, and single tick strings though.
        string htmlTemplate = @"<!-- 
...
<html>
  <head>
    ...
    <style>
      ...
      .syntax-order {
        color: var(--savedSetting_syntaxOrder, #e9a1eb);
      }

      /* for characters `(,)` in `(EV1, EV2)` */
      .syntax-trigger-punctuation {
        color: var(--savedSetting_syntaxTriggerPunctuation, #eeb765);
      }

      .syntax-trigger-name {
        color: var(--savedSetting_syntaxTriggerName, #f1b862);
      }

      .syntax-guard-bracket
      {
        color: var(--savedSetting_syntaxGuardBracket, #00bd2b);
      }
      .syntax-guard-code {
        color: var(--savedSetting_syntaxGuardCode, #a6e19f);
      }

      .syntax-action-start-end {
        color: var(--savedSetting_syntaxActionStartEnd, #e18d33);
      }
      .syntax-action-code {
        color: var(--savedSetting_syntaxActionCode, #cbac8b);
      }
      ...
      .dropdown div.themes button {
        margin-left: 0;
        margin-right: 0;
      }

      .transition {
        stroke: var(--savedSetting_transitionPath, #999) !important;
        stroke-width: 2px !important;
      }

      .transition.pathJustTaken {
        stroke: var(--savedSetting_transitionPathJustTakenColor, #e0aa6c) !important;
        stroke-width: 4px !important;
        stroke-dasharray: 3 6;
        stroke-dashoffset: var(--transition-animation-offset, 0);
        filter: drop-shadow( 3px 3px 2px rgba(0, 0, 0, .7));
      }

      /* give priority over pathJustTaken. If it is available and pathJustTaken, then it will still have dash. */
      .transition.available {
        stroke: var(--savedSetting_transitionPathAvailableColor, #7e70cf) !important;
        stroke-width: 4px !important;
      ...
      .statediagram-state span.nodeLabel span.syntax-vertex-name {
        color: var(--savedSetting_stateTitleTextColor,#eeeeee);
      }
      .statediagram-state.active span.nodeLabel span.syntax-vertex-name {
        color: var(--savedSetting_stateActiveTitleTextColor,#fdffb0) !important;
      }

      .statediagram-state > * {
        fill-opacity: 0.8;
        fill:   var(--savedSetting_stateFillColor, #1f2020) !important;
        stroke: var(--savedSetting_stateStrokeColor, #999999) !important;
      }
      .statediagram-state.active > * {
        fill:   var(--savedSetting_stateActiveFillColor, #3c3224) !important;
        stroke: var(--savedSetting_stateActiveStrokeColor, #d16f3b) !important;
        stroke-width: 2px !important;
      }

      .statediagram-state rect.inner {
        fill: var(--savedSetting_stateNestedFillColor, #333) !important;
      }
      .statediagram-state.active rect.inner {
        fill: var(--savedSetting_stateActiveNestedFillColor, #444) !important;
        stroke-width: 2px !important;
      }

      .clickable:hover {
        cursor: pointer;
        color:  var(--savedSetting_clickableColor, #7fffd4) !important;
      }

      div.dropdown-item input[type='color'] {
        width: 25px;
      }
          ...
          <div class='dropdown'>
            ...
            <div id='myDropdown' class='dropdown-content'>
              ...
              <label class='dropdown-item' for='savedSetting_showEventButtonTooltips'
                 title='Event dispatching buttons will have tooltips with additional info.&#10;📢 NOTE! Changes to this setting take effect on state change or page reload.'>
              ...
              <label class='dropdown-item' for='savedSetting_transitionOffsetAnimation'
                 title=''>
                <input type='checkbox' id='savedSetting_transitionOffsetAnimation' name='savedSetting_transitionOffsetAnimation' checked>
                Animate transition arrows.
              </label>
              ...
              <div class='dropdown-item' style='cursor: default;' >
                <div class='themes'>
                  <select id='theme-select'>
                    ...
                    <option value='dark-pro-1'>Dark Pro 1</option>
                    <option value='dark-pro-2'>Dark Pro 2</option>
                    <option value='original'>Original</option>
                    <option value='tokyo'>Tokyo Night</option>
                    <option value='arctic-void'>Arctic Void</option>
                ...
                <input type='color' id='savedSetting_stateTitleTextColor' value='#ababab' title='Inactive state title text color.'>
                <input type='color' id='savedSetting_stateStrokeColor' value='#999999' title='Inactive state stroke color.'>
                <input type='color' id='savedSetting_stateFillColor' value='#1f2020' title='Inactive state fill color.'>
                <input type='color' id='savedSetting_stateNestedFillColor' value='#333' title='Inactive state nested fill color.'>
                <input type='color' id='savedSetting_stateActiveTitleTextColor' value='#ffffff' title='Active state title text color.'>
                <input type='color' id='savedSetting_stateActiveStrokeColor' value='#e06c75' title='Active state stroke color.'>
                <input type='color' id='savedSetting_stateActiveFillColor' value='#3c3224' title='Active state fill color.'>
                <input type='color' id='savedSetting_stateActiveNestedFillColor' value='#444' title='Active state nested fill color.'>
                <input type='color' id='savedSetting_syntaxOrder' value='#c678dd' title='Text color for behavior order like `1.` in `1. EV`.'>
                <input type='color' id='savedSetting_syntaxTriggerName' value='#cccccc' title='Trigger text color.'>
                <input type='color' id='savedSetting_syntaxTriggerPunctuation' value='#d19a66' title='Text color for characters `(,)` in `(EV1, EV2)`.'>
                <input type='color' id='savedSetting_syntaxGuardBracket' value='#98c379' title='Text color for guard brackets `[]`.'>
                <input type='color' id='savedSetting_syntaxGuardCode' value='#b5d9a0' title='Text color for guard code.'>
                <input type='color' id='savedSetting_syntaxActionStartEnd' value='#d19a66' title='Text color for action code start and end characters `/{}`.'>
                <input type='color' id='savedSetting_syntaxActionCode' value='#abb2bf' title='Text color for action code.'>
                <input type='color' id='savedSetting_transitionPath' value='#999999' title='Color of transition/edge path.'>
                <input type='color' id='savedSetting_transitionPathJustTakenColor' value='#c2c2c2' title='Color of transition/edge path that was just traversed.'>
                <input type='color' id='savedSetting_transitionPathAvailableColor' value='#ffca38' title='Color of transition/edge paths that are ready/available.'>
                <input type='color' id='savedSetting_clickableColor' value='#7fffd4' title='Color of text that is clickable.'>
              </div>
              ...
              <!-- todo-low remove timestamps -->
              <label style='display: none;' class='dropdown-item' for='savedSetting_timestamps'
...
{{jsCode}}
    ...
    <script type='module'>
        ...
        function escapeHtml(str) {
          // Create a new, detached DOM node
          var div = document.createElement('div');

          // Set the textContent to the raw string. The browser automatically escapes special characters.
          div.textContent = str;
        ...
        // listener for resetSettingsButton
        document.getElementById('resetSettingsButton').addEventListener('click', function() {
          if (window.confirm('Are you sure you want to reset all settings to their default values? This will clear all saved settings from localStorage.')) {
            localStorage.clear();
        ...
        function updateCssColorVar(id, color, save=false) {
            document.getElementById(id).value = color;
            document.documentElement.style.setProperty(`--${id}`, color); // custom css vars start with '--'
            if (save)
            {
              localStorage.setItem(id, color);
              console.log(`Saved color input value for '${id}' to '${color}'`);
            }
        }
        ...
        {
          const defaults = {
            stateTitleTextColor: '#ababab',
            stateStrokeColor: '#999999',
            stateFillColor: '#1f2020',
            stateNestedFillColor: '#333',
            stateActiveTitleTextColor: '#ffffff',
            stateActiveStrokeColor: '#e06c75',
            stateActiveFillColor: '#3c3224',
            stateActiveNestedFillColor: '#444',
            syntaxOrder: '#c678dd',
            syntaxTriggerName: '#cccccc',
            syntaxTriggerPunctuation: '#d19a66',
            syntaxGuardBracket: '#98c379',
            syntaxGuardCode: '#b5d9a0',
            syntaxActionStartEnd: '#d19a66',
            syntaxActionCode: '#abb2bf',
            transitionPath: '#999999',
            transitionPathJustTakenColor: '#c2c2c2',
            transitionPathAvailableColor: '#ffca38',
            clickableColor: '#24f0ff',
          };
          ...
          const themes = {
            'dark-pro-1': {
              stateTitleTextColor:          '#ababab',
              stateStrokeColor:             '#999999',
              stateFillColor:               '#3d3d3d',
              stateNestedFillColor:         '#303030',
              stateActiveTitleTextColor:    '#fff',
              stateActiveStrokeColor:       '#ffffff',
              stateActiveFillColor:         '#181e20',
              stateActiveNestedFillColor:   '#4c4e52',
              syntaxOrder:                  '#c678dd',
              syntaxTriggerName:            '#cccccc',
              syntaxTriggerPunctuation:     '#d19a66',
              syntaxGuardBracket:           '#98c379',
              syntaxGuardCode:              '#b5d9a0',
              syntaxActionStartEnd:         '#d19a66',
              syntaxActionCode:             '#d2d2b6',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#c7c7c7',
              transitionPathAvailableColor: '#ddd840',
              clickableColor:               '#f09800',
            },
            'dark-pro-2': {
              stateTitleTextColor:          '#eeeeee',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#fffacd',
              stateActiveStrokeColor:       '#e06c75',
              syntaxOrder:                  '#c678dd',
              syntaxTriggerName:            '#e5c07b',
              syntaxTriggerPunctuation:     '#d19a66',
              syntaxGuardBracket:           '#98c379',
              syntaxGuardCode:              '#b5d9a0',
              syntaxActionStartEnd:         '#d19a66',
              ...
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#c2c2c2',
              transitionPathAvailableColor: '#e5c07b',
              clickableColor:               '#7fffd4',
            },
            'original': {
              stateTitleTextColor:          '#e1e0bc',
              stateStrokeColor:             '#999999',
              stateFillColor:               '#1f2020',
              stateNestedFillColor:         '#333',
              stateActiveTitleTextColor:    '#fdffb0',
              stateActiveStrokeColor:       '#d16f3b',
              stateActiveFillColor:         '#3c3224',
              stateActiveNestedFillColor:   '#444',
              syntaxOrder:                  '#e9a1eb',
              syntaxTriggerName:            '#f1b862',
              syntaxTriggerPunctuation:     '#eeb765',
              syntaxGuardBracket:           '#00bd2b',
              syntaxGuardCode:              '#a6e19f',
              syntaxActionStartEnd:         '#e18d33',
              syntaxActionCode:             '#cbac8b',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#a3a3a3',
              transitionPathAvailableColor: '#fff82e',
              clickableColor:               '#7fffd4',
            },
            'arctic-void': {
              stateTitleTextColor:          '#eeeeee',
              stateStrokeColor:             '#999999',
              stateFillColor:               '#333333',
              stateNestedFillColor:         '#303030',
              stateActiveTitleTextColor:    '#d4f0ff',
              stateActiveStrokeColor:       '#3888e0',
              stateActiveFillColor:         '#262f40',
              stateActiveNestedFillColor:   '#383b47',
              syntaxOrder:                  '#c080f0',
              syntaxTriggerName:            '#60c8f8',
              syntaxTriggerPunctuation:     '#70b8e8',
              syntaxGuardBracket:           '#00d8a0',
              syntaxGuardCode:              '#80e8cc',
              syntaxActionStartEnd:         '#4898e8',
              syntaxActionCode:             '#8ab8d0',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#7090a8',
              transitionPathAvailableColor: '#00e8ff',
              clickableColor:               '#7fffd4',
            },
            'dracula': {
              stateTitleTextColor:          '#b5b5b5',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#f8f8f2',
              stateActiveStrokeColor:       '#ff5555',
              syntaxOrder:                  '#ff79c6',
              syntaxTriggerName:            '#d1d1d1',
              syntaxTriggerPunctuation:     '#ffb86c',
              syntaxGuardBracket:           '#50fa7b',
              syntaxGuardCode:              '#8af5a4',
              syntaxActionStartEnd:         '#bd93f9',
              syntaxActionCode:             '#8be9fd',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#6272a4',
              transitionPathAvailableColor: '#38ff4f',
              clickableColor:               '#7fffd4',
            },
            'tokyo': {
              stateTitleTextColor:          '#eeeeee',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#cdd6f4',
              stateActiveStrokeColor:       '#f7768e',
              syntaxOrder:                  '#bb9af7',
              syntaxTriggerName:            '#e0af68',
              syntaxTriggerPunctuation:     '#ff9e64',
              syntaxGuardBracket:           '#73daca',
              syntaxGuardCode:              '#9eddcc',
              syntaxActionStartEnd:         '#ff9e64',
              syntaxActionCode:             '#7dcfff',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#565f89',
              transitionPathAvailableColor: '#e0af68',
              clickableColor:               '#7fffd4',
            },
            'github-dark': {
              stateTitleTextColor:          '#eeeeee',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#e6edf3',
              stateActiveStrokeColor:       '#f85149',
              syntaxOrder:                  '#d2a8ff',
              syntaxTriggerName:            '#ffa657',
              syntaxTriggerPunctuation:     '#ffa657',
              syntaxGuardBracket:           '#3fb950',
              syntaxGuardCode:              '#7ee787',
              syntaxActionStartEnd:         '#79c0ff',
              syntaxActionCode:             '#a5d6ff',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#6e7681',
              transitionPathAvailableColor: '#e3b341',
              clickableColor:               '#7fffd4',
            },
            'night-owl': {
              stateTitleTextColor:          '#eeeeee',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#d6deeb',
              stateActiveStrokeColor:       '#ef5350',
              syntaxOrder:                  '#c792ea',
              syntaxTriggerName:            '#ffcb8b',
              syntaxTriggerPunctuation:     '#f78c6c',
              syntaxGuardBracket:           '#addb67',
              syntaxGuardCode:              '#c5e99b',
              syntaxActionStartEnd:         '#f78c6c',
              syntaxActionCode:             '#7fdbca',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#637777',
              transitionPathAvailableColor: '#ffcb8b',
              clickableColor:               '#7fffd4',
            },
            'monochrome': {
              stateTitleTextColor:          '#eeeeee',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#f0f0f0',
              stateActiveStrokeColor:       '#aaaaaa',
              syntaxOrder:                  '#999999',
              syntaxTriggerName:            '#dddddd',
              syntaxTriggerPunctuation:     '#cccccc',
              syntaxGuardBracket:           '#eeeeee',
              syntaxGuardCode:              '#bbbbbb',
              syntaxActionStartEnd:         '#cccccc',
              syntaxActionCode:             '#888888',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#b0b0b0',
              transitionPathAvailableColor: '#ffffff',
              clickableColor:               '#7fffd4',
            },
            'white': {
              stateTitleTextColor:          '#ffffff',
              stateStrokeColor:             '#ffffff',
              stateActiveTitleTextColor:    '#ffffff',
              stateActiveStrokeColor:       '#ffffff',
              syntaxOrder:                  '#ffffff',
              syntaxTriggerName:            '#ffffff',
              syntaxTriggerPunctuation:     '#ffffff',
              syntaxGuardBracket:           '#ffffff',
              syntaxGuardCode:              '#ffffff',
              syntaxActionStartEnd:         '#ffffff',
              syntaxActionCode:             '#ffffff',
              transitionPath:               '#ffffff',
              transitionPathJustTakenColor: '#ffffff',
              transitionPathAvailableColor: '#ffffff',
              clickableColor:               '#7fffd4',
            },
            'sepia': {
              stateTitleTextColor:          '#c4b49a',
              stateStrokeColor:             '#999999',
              stateActiveTitleTextColor:    '#e8dbb0',
              stateActiveStrokeColor:       '#a0622a',
              syntaxOrder:                  '#b08878',
              syntaxTriggerName:            '#c49a52',
              syntaxTriggerPunctuation:     '#b8903e',
              syntaxGuardBracket:           '#a87840',
              syntaxGuardCode:              '#a89070',
              syntaxActionStartEnd:         '#a87840',
              syntaxActionCode:             '#a89070',
              transitionPath:               '#999999',
              transitionPathJustTakenColor: '#8c7e6a',
              transitionPathAvailableColor: '#c9a84c',
              clickableColor:               '#7fffd4',
            },
          }

          function setDefaults(save=false)
          {
            for (const [key, value] of Object.entries(defaults)) {
              updateCssColorVar('savedSetting_' + key, value, save);
            }
          }

          function setTheme(themeId, save=false)
          {
            setDefaults(save);
          ...
          document.getElementById('theme-select').addEventListener('change', () => {
              ...
              if (!themeId) return;
              const save=true;
              setTheme(themeId, save);
          });

          setTheme('dark-pro-1');
        }

        // setup custom color storage.
        // MUST come after above so that stored settings applied after default theme.
        {
          const colorInputs = document.querySelectorAll(`.dropdown-content input[type='color']`);
          colorInputs.forEach(inputWidget => {
            // append a note to the input title that the value is saved in localStorage
            inputWidget.title += '\nThis custom color value is saved in localStorage and will persist across page reloads.';

            // Restore state from localStorage
            const savedColor = localStorage.getItem(inputWidget.id);
            if (savedColor !== null) {
              inputWidget.value = savedColor;
              updateCssColorVar(inputWidget.id, savedColor);
              console.log(`Restored color input value for '${inputWidget.id}' to '${inputWidget.value}'`, inputWidget);
            }

            // Save state to localStorage on change
            inputWidget.addEventListener('input', function() {
              const save=true;
              updateCssColorVar(inputWidget.id, this.value, save);
            });

            // update current css style
            updateCssColorVar(inputWidget.id, inputWidget.value);
          });
        }

        // animate transition edges
        {
          setInterval(()=>{
            // only do if animation is enabled
            if (document.getElementById('savedSetting_transitionOffsetAnimation').checked === false) {
              return;
            }

            let offset = document.documentElement.style.getPropertyValue('--transition-animation-offset');
            offset -= 1;
            document.documentElement.style.setProperty('--transition-animation-offset', offset);
          }, 50);
        }
        ...
        function updateEventButtonStates(currentStateDiagramName) {
            ...
            diagramEventNamesArray.forEach(eventName => {
                ...
                if (button) {
                    ...
                    title += '\nThere is a ⚙️ setting to disable these tooltips.';
        ...
        sm.tracer = {
            ...
            logGuardCodeEvaluation: (guardCode) => {
                sm.tracer.log(`<span title='Guard code manually evaluated by user for simulation.'>🛡️ Guard: <span class='syntax-guard-bracket'>[</span><span class='syntax-guard-code'>${escapeHtml(guardCode)}</span><span class='syntax-guard-bracket'>]</span></span>`, true);
            },
            logActionCode: (actionCode) => {
                sm.tracer.log(`<span title='Your actual state machine will run this action code.'>⚡ Action: <span class='syntax-action-code'>${escapeHtml(actionCode)}</span></span>`, true);
            },
