        ...
        <div class='titlebar'>Events
          <div class='dropdown'>
            ...
            <div id='myDropdown' class='dropdown-content'>
              ...
              <!-- 
                NOTE! When adding new settings, be sure to also update the code that saves and restores the checkbox states using localStorage.
                NOTE! Try not to change the ids of input checkboxes below as that will reset user preferences stored in localStorage.
               -->

              <label class='dropdown-item' for='settings_hideIrrelevantEvents'
                title='When enabled, event dispatching buttons will be hidden if the current active state(s) ignore the event.'>
                <input type='checkbox' id='settings_hideIrrelevantEvents' name='settings_hideIrrelevantEvents'>
                Hide ignored event buttons
              </label>
              <label class='dropdown-item' for='settings_verboseEnter'
                title='Every time a state is entered, it will be logged below in the event log.'>
                <input type='checkbox' id='settings_verboseEnter' name='settings_verboseEnter' checked>
                Log State Entry
              </label>
              <label class='dropdown-item' for='settings_verboseExit'
                title='Every time a state is exited, it will be logged below in the event log.'>
                <input type='checkbox' id='settings_verboseExit' name='settings_verboseExit' checked>
                Log State Exit
              </label>
              <label class='dropdown-item' for='settings_verboseHistory'
                title='Log history pseudo state variable updates'>
                <input type='checkbox' id='settings_verboseHistory' name='settings_verboseHistory' checked>
                Log History Variables
              </label>
              <label class='dropdown-item' for='settings_timestamps'
                title='Controls whether timestamps are shown along side event dispatches.'>
                <input type='checkbox' id='settings_timestamps' name='settings_timestamps'>
                Timestamps
              </label>
            </div>
          </div>
...
{{jsCode}}
    ...
    <script type='module'>
        ...
        document.getElementById('settings_timestamps').addEventListener('change', function() {
          if(this.checked) {
        ...
        document.getElementById('settings_hideIrrelevantEvents').addEventListener('change', function() {
        ...
        function updateButtonVisibility() {
            const settings_hideIrrelevantEvents = document.getElementById('settings_hideIrrelevantEvents').checked;
            
            diagramEventNamesArray.forEach(eventName => {
                const button = document.getElementById('button_' + eventName);
                if (button) {
                    // Toggle hidden class based on checkbox state and button has no event handler
                    button.classList.toggle('hidden', settings_hideIrrelevantEvents && button.classList.contains('hasNoEventHandler'));
                }
            });
        }
        ...
        sm.tracer = {
            enterState: (mermaidName) => {
                ...
                if (document.getElementById('settings_verboseEnter').checked) {
            ...
            exitState: (mermaidName) => {
                ...
                if (document.getElementById('settings_verboseExit').checked) {
            ...
            logHistoryVarUpdate: (varName, newValue) => {
                if (document.getElementById('settings_verboseHistory').checked) {
