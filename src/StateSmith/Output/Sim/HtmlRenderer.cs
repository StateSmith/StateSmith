  ...
  <head>
    ...
    <style>
      ...
      .transition.pathJustTaken {
        stroke: var(--savedSetting_transitionPathJustTakenColor, #e0aa6c) !important;  /* note that var name matches savedSetting_ */
      ...
      .transition.available {
        stroke: var(--savedSetting_transitionAvailableColor, #7e70cf) !important;  /* note that var name matches savedSetting_ */
        stroke-width: 4px !important;
      ...
      .statediagram-state.active > * {
        ...
        stroke: var(--savedSetting_stateActiveStrokeColor, #d16f3b) !important;   /* note that var name matches savedSetting_ */
        stroke-width: 2px !important;
      }
          ...
          <div class='dropdown'>
            ...
            <div id='myDropdown' class='dropdown-content'>
              ...
              <div class='dropdown-item' style='cursor: default;' >
                Colors:
                <!-- 
                  NOTE!!! These IDs match css variables.
                -->
                <input type='color' id='savedSetting_transitionPathJustTakenColor' value='#a3a3a3' title='Color of transition/edge path that was just traversed.'>
                <input type='color' id='savedSetting_transitionAvailableColor' value='#fff82e' title='Color of transition/edge paths that are ready/available.'>
                <input type='color' id='savedSetting_stateActiveStrokeColor' value='#d16f3b' title='Active state stroke color.'>
                <input type='color' id='savedSetting_stateActiveTitleTextColor' value='#fdffb0' title='Active state title text color.'>
              </div>
        ...
        // setup custom color storage
        {
          ...
          colorInputs.forEach(inputWidget => {
            ...
            if (savedColor !== null) {
              ...
              updateCssColorVar(inputWidget, savedColor);
            ...
            inputWidget.addEventListener('input', function() {
              localStorage.setItem(inputWidget.id, this.value);
              updateCssColorVar(inputWidget, this.value);
              console.log(`Saved color input value for '${inputWidget.id}' to '${this.value}'`, inputWidget);
            });

            // update current css style
            updateCssColorVar(inputWidget, inputWidget.value);
          });

          function updateCssColorVar(inputWidget, color) {
              document.documentElement.style.setProperty(`--${inputWidget.id}`, color); // custom css vars start with '--'
          }
        }
