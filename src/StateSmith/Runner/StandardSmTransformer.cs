...
public class StandardSmTransformer : SmTransformer
{
    ...
    public StandardSmTransformer(CNameMangler mangler, RenderConfigVerticesProcessor renderConfigVerticesProcessor)
    {
        ...
        AddStep(TransformationId.Standard_SupportHistory, (sm) => HistoryProcessor.Process(sm, mangler));
