...
// Thread safe.
char const * const LaserTagMenu1Sm_state_id_to_string(LaserTagMenu1Sm_StateId id);

// Thread safe.
char const * const LaserTagMenu1Sm_event_id_to_string(LaserTagMenu1Sm_EventId id);
