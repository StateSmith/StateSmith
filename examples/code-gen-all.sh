...
cd $EXAMPLES_DIR/BlankTemplate/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll

cd $EXAMPLES_DIR/Blinky1/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll

cd $EXAMPLES_DIR/Blinky1Printf/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll

cd $EXAMPLES_DIR/ButtonSm1Cpp/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll

cd $EXAMPLES_DIR/LaserTagMenu1/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll

cd $EXAMPLES_DIR/Tutorial1-blank/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll

cd $EXAMPLES_DIR/Tutorial1-complete/CodeGen/
sed -i "s/\"StateSmith\" Version=\".*\"/\"StateSmith\" Version=\"$NUGET_VERSION\"/" CodeGen.csproj
dotnet build
dotnet ./bin/Debug/net6.0/CodeGen.dll
