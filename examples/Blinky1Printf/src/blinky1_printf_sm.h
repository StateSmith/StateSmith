...
// Thread safe.
char const * const blinky1_printf_sm_state_id_to_string(blinky1_printf_sm_state_id_t id);

// Thread safe.
char const * const blinky1_printf_sm_event_id_to_string(blinky1_printf_sm_event_id_t id);
